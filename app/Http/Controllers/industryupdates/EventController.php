...
class EventController extends HomeController
{
    ...
    {      
       ...
       $data = Event::where('active_flag','=', 1)->where('end_date', '>=' , $this->time)->orderBy('start_date', 'ASC')->select('start_date','end_date','title','venue','event_organiser','email','web_link')->limit(60)->get();
