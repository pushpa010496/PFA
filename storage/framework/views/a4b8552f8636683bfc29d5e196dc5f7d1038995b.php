          ...
          <div class="row">
              ...
              <table border="1" cellpadding="1" cellspacing="1" style="width:100%" align="center" class="hoverTable mt-10">
                ...
                <tbody>
                  ...
                  <tr class="rowcheck" data-id="<?php echo e(config('app.url')); ?>images/prime-banner-shot.jpg">
                    <td><img src="<?php echo e(config('app.url')); ?>images/popup-icon.png" alt="Hover me" width="14" class="mr-2" /> Prime Banner</td>
                    <td style="text-align: center;">800 x 220</td>
                  </tr>
                  <tr class="rowcheck" data-id="<?php echo e(config('app.url')); ?>images/slider-banner-shot.jpg">
                    <td><img src="<?php echo e(config('app.url')); ?>images/popup-icon.png" alt="Hover me" width="14" class="mr-2" /> Slider</td>
                    <td style="text-align: center;">878 x 345</td>
                  </tr>
                  <tr class="rowcheck" data-id="<?php echo e(config('app.url')); ?>images/top-full-banner-shot.jpg">
                  ...
                  <tr class="rowcheck" data-id="<?php echo e(config('app.url')); ?>images/square-banner-shot.jpg">
                    <td><img src="<?php echo e(config('app.url')); ?>images/popup-icon.png" alt="Hover me" width="14" class="mr-2" /> Square Banner</td>
                    <td style="text-align: center;">300 x 250</td>
                  </tr>
                  <tr class="rowcheck" data-id="<?php echo e(config('app.url')); ?>images/sky-tower-banner-shot.jpg">
                    <td><img src="<?php echo e(config('app.url')); ?>images/popup-icon.png" alt="Hover me" width="14" class="mr-2" /> Sky Tower Banner</td>
                    <td style="text-align: center;">300 x 600</td>
                  </tr>
                  <tr class="rowcheck" data-id="<?php echo e(config('app.url')); ?>images/base-banner-shot.jpg">
                    <td><img src="<?php echo e(config('app.url')); ?>images/popup-icon.png" alt="Hover me" width="14" class="mr-2" /> Base Banner</td>
                    <td style="text-align: center;">468 x 60</td>
                  </tr>
                </tbody>
              </table> 
            ...
            <div class="col-lg-5 col-xs-12 form-bg mt-1">
              <div class="p-3">
                ...
                <form role='form' action="<?php echo e(route('banner.advertisement.post')); ?>" method="post" accept-charset="utf-8" class="email" id="writemessage">  
                  <?php echo e(csrf_field()); ?>

                  <div class="row"> 
                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php echo e($errors->first('fullname', 'has-error')); ?>">
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php echo e($errors->first('email', 'has-error')); ?>">
                  ...
                  <div class="row"> 
                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php echo e($errors->first('telephone', 'has-error')); ?>">
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php echo e($errors->first('company', 'has-error')); ?>">
                  ...
                  <div class="row"> 
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 <?php echo e($errors->first('description', 'has-error')); ?>">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pt-3" align="center">  
        <table border="0" cellpadding="1" cellspacing="1" style="width:100%" align="center" class="mt-1">
          ...
          <tbody>
            <tr>
              <td colspan="2">
                <img width="100%" src="<?php echo e(config('app.url')); ?>images/pfa-geographical-breakdown.jpg" class="img-responsive" alt="Geographical"/>
              </td>
            </tr>             
          </tbody>
        </table>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/cms/banner-advertisement/index.blade.php ENDPATH**/ ?>