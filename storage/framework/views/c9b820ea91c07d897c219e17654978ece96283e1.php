...
#frame1 {position:absolute;top:-1px;left:-1px;width:300px;height:250px;opacity:0;background:url("<?php echo e(config('app.url')); ?>promotions/emirates_banner/01.jpg");}
#frame2 {position:absolute;top:-1px;left:-1px;width:300px;height:250px;opacity:0;background:url("<?php echo e(config('app.url')); ?>promotions/emirates_banner/02.png");}
#frame3 {position:absolute;top:-1px;left:-1px;width:300px;height:250px;opacity:0;background:url("<?php echo e(config('app.url')); ?>promotions/emirates_banner/03.png");}
#frame4 {position:absolute;top:-1px;left:-1px;width:300px;height:250px;opacity:0;background:url("<?php echo e(config('app.url')); ?>promotions/emirates_banner/04.png");}
#frame5 {position:absolute;top:-1px;left:-1px;width:300px;height:250px;opacity:0;background:url("<?php echo e(config('app.url')); ?>promotions/emirates_banner/05.png");}
#frame6 {position:absolute;top:-1px;left:-1px;width:300px;height:250px;opacity:0;background:url("<?php echo e(config('app.url')); ?>promotions/emirates_banner/06.png");}
#frame7 {position:absolute;top:-1px;left:-1px;width:300px;height:250px;opacity:0;background:url("<?php echo e(config('app.url')); ?>promotions/emirates_banner/07.png");}
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/cms/right-banner-adv.blade.php ENDPATH**/ ?>