...
<div class="container">
	...
	<div class="border mt-4 mb-4 p-4">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-12 ebook">	
				...
				<img src="<?php echo e(config('app.url')); ?>images/latest-issue-devices-banner.jpg" alt="Digital Version" class="img-fluid">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-12 mag">
				...
				<img src="<?php echo e(config('app.url')); ?>images/4-magazine.png" alt="Print Version" class="img-fluid">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-12 mailing">
				...
				<img src="<?php echo e(config('app.url')); ?>images/mailing-address.png" alt="Mmailing Address" class="img-fluid">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p> Your subscribtion for Asian hospital and healthcare management is successfully completed. </p>
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-seconadry" role="button"   id="aa" name="aa" href="<?php echo e(url('/subscribe')); ?>" aria-expanded="false">
			...
			<div class="ebook">
				...
				<form action="<?php echo e(url('magazine-subscribe-post')); ?>" method="Post" enctype="multipart/form-data">
						...
						<div class="row">       
							...
							<div class="col-md-4 col-sm-6 col-12 mb-3">
								...
								<!-- <select class="form-control" id="country" name="country" placeholder="Country*" required="">
								 ...
								 <?php echo e(Form::select('country', $countries, null, ['class' => 'form-control','required'=>'required'])); ?>


                      <span class="help-block"><?php echo e($errors->first('country', ':message')); ?>
					...
					<div class="row">        
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" class="custom-control-input" id="strategy" value="strategy">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" value="Clinical_Trials" class="custom-control-input" id="Clinical_Trials">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" value="Manufacturing" class="custom-control-input" id="Manufacturing">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" value="Research_Development" class="custom-control-input" id="R_D">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" value="Information_Technology" class="custom-control-input" id="I_T">
						...
						<div class="col-md-12 pt-2">
							...
							<div class="form-group">
								...
								<img src="<?php echo e(config('app.url')); ?>images/pharma-newsletter-logo.jpg" alt="Pharma Subscription" class="img-fluid mb-2" />
								...
								<div class="custom-control custom-checkbox">
									...
									<label class="custom-control-label" for="newsletter">Tick here if you wish to receive Verticaltalk Pharma e-Newsletter</label>
			...
			<div class="mag">
				...
				<form action="<?php echo e(url('magazine-subscribe-post')); ?>" method="Post" enctype="multipart/form-data">		<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
 ...
 <?php echo e(Form::select('country', $countries, null, ['class' => 'form-control','required'=>'required'])); ?>
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="int[]" class="custom-control-input" id="strategy1" value="strategy1" required="">

									<label class="custom-control-label" for="strategy1">Strategy</label>

								</div>

								<div class="custom-control custom-checkbox">

									<input type="checkbox" name="int[]" value="Clinical_Trials1" class="custom-control-input" id="Clinical_Trials1" required="">

									<label class="custom-control-label" for="Clinical_Trials1">Clinical Trials</label>

								</div>

								<div class="custom-control custom-checkbox">

									<input type="checkbox" name="int[]" value="Manufacturing1" class="custom-control-input" id="Manufacturing1" required="">

									<label class="custom-control-label" for="Manufacturing1">Manufacturing</label>

								</div>

								<div class="custom-control custom-checkbox">

									<input type="checkbox" name="int[]" value="R_D1" class="custom-control-input" id="R_D1" required="">

									<label class="custom-control-label" for="R_D1">Research & Development</label>

								</div>

								<div class="custom-control custom-checkbox">

									<input type="checkbox" name="int[]" value="I_T1" class="custom-control-input" id="I_T1" required="">
						...
						<div class="col-md-12 pt-2">
							...
							<div class="form-group">
								...
								<div class="custom-control custom-checkbox">
									...
									<label class="custom-control-label" for="newsletter1">Tick here if you wish to receive Verticaltalk pharma e-Newsletter</label>
  ...
  <?php endif; ?>  
	...
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/forms/subscribe/index.blade.php ENDPATH**/ ?>