...
새로운 환경에서 임상 시험 설계 및 데이터 수집 탐색</title>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>images/oracle-health-sciences-embrance-korean-og.png" />
...
<body>
	...
	<div class="container-fluid shadow">	
		<div class="row">
			<img src="<?php echo e(config('app.url')); ?>images/oracle-health-sciences-embrance-korean-banner.png" alt="Oracle - AI Revolution in Multivigilance" class="img-fluid">
		</div>		
	</div>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-12 pt-3 pb-4">
				...
				<div class="form-bg p-3"> 
					...
					<form action="<?php echo e(route('oracleExploreClinicaltrialKorean.post')); ?>" method="post">
...
비즈니스 이메일*" value="<?php echo e(old('email')); ?>" required>
...
직위*" value="<?php echo e(old('job_title')); ?>" required>
...
회사 이름*" value="<?php echo e(old('company')); ?>" required>
...
업무용 전화*" value="<?php echo e(old('phone')); ?>" required>
...
우편번호*" value="<?php echo e(old('zip_code')); ?>" required>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-seconadry" role="button" id="aa" name="aa"  href="<?php echo e(url('promotion/oracle-explore-clinicaltrial-korean')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/flatpages/oracle-explore-clinicaltrial-korean.blade.php ENDPATH**/ ?>