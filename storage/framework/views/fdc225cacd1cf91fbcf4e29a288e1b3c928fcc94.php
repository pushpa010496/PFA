      ...
      <div class="container">
        ...
        <div class="row PF-MobP030">
          ...
          <div class="col-lg-3 pr-0 text-right">
            <a href="<?php echo e(url('/newswires')); ?>" class="btn btn-sm btn-dark text-white"><span class="small">READ MORE...</span></a>   
          </div>
        </div>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 title-list">
                <h2 class="mb-0 PF-TXTBlk000">
                  <a href="<?php echo e(route('pressreleases.url',[$val->url])); ?>" title="<?php echo e($val->title_tag); ?>" class="PF-TXTBlk000"><?php echo e($val->title); ?></a>
                </h2>
...
<script type="text/javascript">
  var url = "<?php echo e(url('pressreleases/more')); ?>";
  <?php echo $__env->make('layouts/partials/_loadmorejs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/pressreleases/index.blade.php ENDPATH**/ ?>