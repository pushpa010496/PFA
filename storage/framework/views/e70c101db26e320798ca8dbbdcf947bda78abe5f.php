...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/yokogawa/yokogawa-og.jpg" />
	...
	<meta property="og:url" content="<?php echo e(url('yokogawa-webinar')); ?>" />
		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-8 my-auto offset-md-4 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/yokogawa/yokogawa-logo.jpg" alt="YOKOGAWA" class="ml-2 img-fluid">
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/yokogawa/yokogawa-banner.jpg" alt="YOKOGAWA" title="YOKOGAWA" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-12 person pt-3">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow" align="center">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/yokogawa/paul-cizdziel.jpg" alt="Paul E. Cizdziel" title="Paul E. Cizdziel" class="img-fluid rounded-circle border" />
					<div class="pt-2">
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?php echo e(url('yokogawa-webinar-success')); ?>" method="post" >
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/yokogawawebinar/index.blade.php ENDPATH**/ ?>