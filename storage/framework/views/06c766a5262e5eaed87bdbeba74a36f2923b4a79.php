          ...
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
               ...
               <?php echo e(trans('messages.authorguidelines-download_title')); ?>          
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 PF-BrdrDDD p-1">
	            ...
	            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pb-2">
	                ...
	                <div class="PF-BrdrBEEE col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0 mb-1">
	                  ...
	                  <h1 class="PF-Bshelf pt-2"><?php echo e(trans('messages.authorguidelines-download_title')); ?></h1>            
            	...
            	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  	...
                  	<p><?php echo e(trans('messages.authorguidelines-download_text')); ?></p>
	            ...
	            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			        ...
			        <div class="text-center pb-3 pt-2">
		          	...
		          	<div class="form-area col-lg-12 col-md-12 col-sm-12 mt-2">  
		            	...
		            	<form action="<?php echo e(url('/authorguidelines-download')); ?>" class="email" id="writemessage" method="post" accept-charset="utf-8">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/magazine/authorguidelines/download.blade.php ENDPATH**/ ?>