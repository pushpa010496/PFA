...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/oracle/series2/oracle-series2-ondemand-og.jpg" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="<?php echo e(config('app.url')); ?>webinars/oracle/series2/english-ondemand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/oracle/series2/english-videosuccess.blade.php ENDPATH**/ ?>