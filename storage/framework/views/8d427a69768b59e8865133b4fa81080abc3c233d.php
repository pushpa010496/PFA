...
<?php if(@$pdf1 != ''): ?>
    ...
    <a href="<?php echo e($pdf1); ?>">Biozen dSEC Column Product Guide</a>
...
<?php if(@$pdf2 != ''): ?>
    ...
    <a href="<?php echo e($pdf2); ?>">Drugs and Metabolites Guide</a>
...
<?php if(@$pdf3 != ''): ?>
    ...
    <a href="<?php echo e($pdf3); ?>">bioZen Nano LC Application Guide</a>
...
<?php if(@$pdf4 != ''): ?>
    ...
    <a href="<?php echo e($pdf4); ?>">Sample Preparation Made Simple</a>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/emails/flatpages/client_full_msg_biozen.blade.php ENDPATH**/ ?>