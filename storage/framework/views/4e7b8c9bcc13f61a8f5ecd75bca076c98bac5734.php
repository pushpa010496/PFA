...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/nsf-webinar/nsf-webinar-banner-og.jpg" />
	<link rel="canonical" href="<?php echo e(URL::current('nsf-webinar')); ?>" />
...
<body>
		...
		<div class="container">
			<div class="row">
				...
				<p class="mb-0">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/nsf-webinar/nsf-logo.jpg" alt="nsf_logo" title="nsf_logo" class="img-fluid mt-1 mb-1" style='width:100%;max-width:90px;'>
	...
	<div class="container shadow">
		<div class="row position-relative">
			...
			<img class="w-100" src="<?php echo e(config('app.url')); ?>webinars/nsf-webinar/nsf-webinar-banner.jpg" alt="nsf-banner" title="nsf-banner" class="img-fluid">
		</div>
	</div>
...
2023 a successful year for your company. </p>
			...
			<div class="col-lg-4 col-12 my-4">
				<div class="form-bg shadow p-3">
					...
					<form action="<?php echo e(route('nsfWebinar.post')); ?>" method="post" id="writemessage">
						<?php echo csrf_field(); ?>
				...
				<div class="p-2 PF-BrdrDDD mb-2 mt-2 bg-sky shadow">	 
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-12 col-12 text-center">
							<img src="<?php echo e(config('app.url')); ?>webinars/nsf-webinar/sanjay-shetgar.PNG" alt="sanjay-shetgar" title="sanjay-shetgar" class="img-fluid">
						</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a class="btn btn-seconadry" role="button" id="aa" name="aa" href="<?php echo e(url('/promotion/nsf-webinar')); ?>" aria-expanded="false">
						Close
					</a>
				</div>
			</div>
...
</html><?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/nsf-webinar/index.blade.php ENDPATH**/ ?>