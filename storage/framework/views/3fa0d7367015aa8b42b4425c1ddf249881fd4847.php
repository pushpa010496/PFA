        ...
        <div class="row PF-MobP030">
          ...
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active PF-TXTRED" aria-current="page"><?php echo e(trans('messages.casestudies_title')); ?></li>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pb-2">
                ...
                <div class="PF-BrdrBEEE col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0 mb-3">
                  ...
                  <h1 class="PF-Bshelf pt-2"><?php echo e(trans('messages.casestudies_title')); ?></h1>            

                </div>

                <p><?php echo e(trans('messages.casestudies_text')); ?></p>
              ...
              <?php $__currentLoopData = $casestudies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 title-list">

                <h2 class="mb-1 PF-TXTBlk000">

                  <a href="<?php echo e(route('casestudies.url',[$val->url])); ?>" title="<?php echo e($val->title_tag); ?>" class="PF-TXTBlk000"><?php echo e($val->title); ?></a>
...
<script type="text/javascript">
  ...
  var url = "<?php echo e(url('casestudies/more')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/knowledgebank/casestudies/index.blade.php ENDPATH**/ ?>