	            ...
	            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			        ...
			        <div class="text-center pb-3 pt-2">
		          	...
		          	<div class="form-area col-lg-12 col-md-12 col-sm-12 mt-2">  
		            	...
		            	<form action="<?php echo e(route('casestudiesform.post',[$casestudy->url])); ?>" class="email" id="writemessage" method="post" accept-charset="utf-8">
			              	...
			              	<div class="row">
				                ...
				                <div class="form-group col-lg-6 <?php echo e($errors->first('fullname', 'has-error')); ?>">
				                	...
				                	<input type="hidden" value="<?php echo e($casestudy->id); ?>" name="casestudy_id" id="type">


				                	<input type="hidden" value="<?php echo e($casestudy->title); ?>" name="title">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/knowledgebank/casestudies/download.blade.php ENDPATH**/ ?>