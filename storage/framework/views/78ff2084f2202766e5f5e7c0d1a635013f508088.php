      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 PF-P0">
                <nav>
                  ...
                  <ul class="pagination PF-M0 PF-PT10">
                    <li> <a href="<?php echo e(url('/').'/listnews/year/'.date('Y')); ?>" class="PF-BrdrRds0 PF-TXTBlk PF-PointerEvents"> Archives - <span class="PF-IntigerStyle"><?php echo e(date('Y')-1); ?></span></a> </li>
                  ...
                  <ul class="pagination PF-M0 PF-PT10">
                    <li> <a href="<?php echo e(url('/')); ?>/listnews/year/<?php echo e(date('Y')); ?>" class="PF-BrdrRds0 PF-TXTBlk PF-PointerEvents"> Archives - <span class="PF-IntigerStyle"><?php echo e(date('Y')); ?></span></a> </li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12 title-list">
          <h2 class="mb-1 PF-TXTBlk000">
            <a href="<?php echo e(route('news.url',[$val->url])); ?>" title="<?php echo e($val->title_tag); ?>" class="PF-TXTBlk000"><?php echo e($val->title); ?></a>
          </h2>
...
<script type="text/javascript">
  var url = "<?php echo e(url('listnews/month').'/'.$month .'/year/'.$year); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/news/filter.blade.php ENDPATH**/ ?>