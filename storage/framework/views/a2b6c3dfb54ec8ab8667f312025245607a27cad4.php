...
<html>
	...
	<head>
		...
		<meta property="og:image" content="<?php echo e(config('app.url')); ?>zebra/img/cpc-industry-assessment-og.jpg"/>
	

		<link rel="canonical" href="<?php echo e(url('promotion/cpc-industry-assessment')); ?>"/>
...
#registration .copy li input[type='tel']{
	...
	<body>
		...
		<form id="elqForm" name="cpc_form" action="<?php echo e(route('cpcindustryAssessment.post')); ?>" method="post" target="postFrame">
							    ...
							    <div class="modal-content">
							        ...
							        <div class="modal-footer">
							            ...
							            <a class="btn btn-seconadry" role="button" id="aa" name="aa"
							                ...
							                href="<?php echo e(url('promotion/pharma-machinery-assessment-post')); ?>" aria-expanded="false">
			...
			function setBackgrounds() {
			    ...
			    if (screenWidth < 768) {
			        ...
			        $('#main').bgswitcher({
			            ...
			            "<?php echo e(config('app.url')); ?>zebra/img/background-cpn-full-0.jpg",
...
</html><?php /**PATH /home/pharmafocusasia/public_html/resources/views/flatpages/cpc-industry-assessment.blade.php ENDPATH**/ ?>