...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>images/remediation-project-og.jpg" />
	<link rel="canonical" href="<?php echo e(URL::current('lesson-learned-from-successful-remediation-project')); ?>"/>
...
<body>
	...
	<div class="container-fluid shadow">	
		<div class="row">
			...
			<img src="<?php echo e(config('app.url')); ?>images/remediation-project-banner.jpg" alt="Oracle - AI Revolution in Multivigilance" class="img-fluid">
		</div>		
	</div>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-12 pt-3 pb-4">
				...
				<div class="form-bg p-3"> 
					...
					<form action="<?php echo e(route('nsfRemediationproject.post')); ?>" method="post">
						<?php echo csrf_field(); ?>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-seconadry" role="button" id="aa" name="aa"  href="<?php echo e(url('promotion/lesson-learned-from-successful-remediation-project')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
</html><?php /**PATH /home/pharmafocusasia/public_html/resources/views/flatpages/nsf-remediation-project.blade.php ENDPATH**/ ?>