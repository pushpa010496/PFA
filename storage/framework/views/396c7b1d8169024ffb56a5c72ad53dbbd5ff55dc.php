...
<?php if(@$pdf1 != ''): ?>
    ...
    <a href="<?php echo e($pdf1); ?>">The BioFlo ® 320</a>
...
<?php if(@$pdf2 != ''): ?>
    ...
    <a href="<?php echo e($pdf2); ?>"> Application Note</a>
...
<?php if(@$pdf3 != ''): ?>
    ...
    <a href="<?php echo e($pdf3); ?>"> Free eBook</a>
...
<?php if(@$pdf4 != ''): ?>
    ...
    <a href="<?php echo e($pdf4); ?>"> The Stem Cell Community Day</a>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/emails/flatpages/client_msg_eppendorf.blade.php ENDPATH**/ ?>