...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>images/oracle-health-sciences-embrance-og.jpg" />
...
<!-- 
	...
	<div class="container-fluid shadow">	
		<div class="row">
			<img src="<?php echo e(config('app.url')); ?>images/oracle-health-sciences-virtual-banner.jpg" alt="Oracle - AI Revolution in Multivigilance" class="img-fluid">
		</div>		
	</div>
...
way to collect and manage all the clinical data in one place.</p>
			...
			<div class="col-lg-4 col-12 pt-3 pb-4">
				...
				<div class="form-bg p-3"> 
					...
					<form action="<?php echo e(route('oracleEmbraceVirtualTrials.post')); ?>" method="post">
	                  	...
	                  	<div class="form-group <?php echo e($errors->first('zip_code', 'has-error')); ?>">
	                  		<input type="text" class="form-control" name="zip_code" id="zip_code" placeholder="Postal/Zip Code*" value="<?php echo e(old('zip_code')); ?>" required>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-seconadry" role="button" id="aa" name="aa"  href="<?php echo e(url('promotion/oracle-embrace-virtual-trials')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/flatpages/oracle-embrace-virtual-trials.blade.php ENDPATH**/ ?>