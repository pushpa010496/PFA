...
<head>
	...
	<meta property="og:title" content="Pall Biotech Webinar" />
	<meta property="og:description" content="" />
	<meta property="og:Keywords" content="" />

	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/pall-biotech/pall-biotech-ondemand-og.jpg" />

	<link rel="canonical" href="<?php echo e(url('pall-biotech-webinar-aug20')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('pall-biotech-webinar-aug20')); ?>" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/pall-biotech/pall-biotech-logo.png" alt="PALL Biotech" class="ml-2 img-fluid">
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/pall-biotech/pall-biotech-ondemand-banner.jpg" alt="PALL Biotech" title="PALL Biotech" class="img-fluid shadow" />
			</div>

      		<div class="col-lg-7 col-md-7 col-sm-7 col-12 person pt-3">
				<h2 class="font-weight-bold PF-TXTRED font-20">"Filtration in Pharmaceutical and Biopharmaceutical Development & Manufacturing"</h2>
      			<p class="mb-1">Pharmaceutical formulations, drug products, therapies, vaccines and the processes by which they are made are becoming increasingly diverse. Whether used for clarification or sterilization of final material, filtration remains an essential part of them.</p>
      			<p class="mb-1">In this presentation, Tom Watson talks about Pall’s range of filters including carbon removal filters, sterilizing grade filters (liquid and air/gas applications) and pre-filters for different types of drugs and manufacturing processes.</p>
      			<p class="mb-1">You will also understand how Pall Biotech is continuing to innovate in the field of prefiltration and sterilizing grade filtration in response to evolving regulatory standards and changes in drug classes.</p>
            </div> 

			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-4 mb-4">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/pall-biotech/pall-biotech-video-thumb.jpg" alt="Pall Biotech Webinar Video" title="Pall Biotech Webinar Video" class="img-fluid video shadow border text-center" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-7 col-12 pb-3">
				<h3 class="font-weight-bold PF-TXTRED font-18">Participants will learn about:</h3>
      			<ul style="list-style-type:lower-latin; padding-left: 20px; line-height: 1.3;">
					<li>How to select a right filter for your product and process. </li>
					<li>What’s new in the pre-filtration and sterilizing grade filtration. </li>
					<li>Integrity testing of hydrophilic and hydrophobic filters. </li>
      			</ul>
			</div>

			<div class="col-lg-5 col-md-5 col-sm-12 col-12 pb-3">				
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow" align="center">
					<h2 class="mb- pt-2 PF-TXTRED"><strong>6<sup>th</sup> August 2020</strong></h2>
					<p class="small mb-0"><strong>(Thursday)</strong></p>
					<p class="mb-1 mt-1">11:00 AM IST <span class="text-muted ml-1 mr-1">|</span> 1:30 PM SGT <span class="text-muted ml-1 mr-1">|</span>  2:30 PM Japan</p>       
				</div> 				          
			</div>
	...
	<div class="container">	
		<!-- <div class="row">
	        <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 align-self-center">
	        	<div class="bg-primary border p-3 text-white">
	    ...
	    <div class="bg-light border p-2">
	    	<div class="row">
	    		<div class="col-lg-4 col-md-4 col-sm-12 col-12 person pt-3 text-center">				
	    			<div class="" align="center">
	    				<img src="<?php echo e(config('app.url')); ?>webinars/pall-biotech/pall-biotech-tom-watson.jpg" alt="Tom Watson" title="Tom Watson" class="img-fluid border" />
	    				<div class="pt-2">
	    					<p class="person-name TXT-BLUE mb-0">Tom Watson</p>
	    					<p class="gray-text mb-0"><em>Global Product Manager, Sterilizing Grade Filters</em></p>
	    					<p class="small mb-0">Pall Biotech</p>
	    				</div>         
	    			</div> 				          
	    		</div>
	    		<div class="col-lg-8 col-md-8 col-sm-12 col-12 pt-3">
	    			<h2 class="mt-2 font-weight-bold">About - <strong class="PF-TXTRED">Tom Watson</strong></h2>
	    			<p class="mb-1">Tom joined Pall in 2003, having graduated from the University of Sheffield, UK with a degree in Biotechnology and Microbiology.</p>
	    			<p class="mb-1">Following several years as an Account Manager, in 2010 he joined the Global Product Marketing first as Global Product Manager, Sterilizing-grade Filters and is now marketing group leader for Sterilizing grade filters, test instruments and systems.</p>
	    		</div>
	    	</div>
	    </div>
	</div>	
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?php echo e(url('pall-biotech-webinar-aug20-success')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									...
									<input type="hidden" name="type" id="type" value="pall-biotech-webinar-aug20-video" />
									<input type="hidden" name="client_message" value="Thank you for showing interest in Pall Biotech Webinar. The live link will be available a few hours prior to the webinar. You may receive a confirmation call shortly from one of our team members.">
									<input type="hidden" name="thank_message" value="Your registration for Pall Biotech Webinar  is successful. One of our team will get back to you soon.">
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label small" for="email_updates">I would like to receive email updates about Pall Biotech Webinar products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label small" for="representative">I have more questions and would like to be contacted by a Pall Biotech Webinar representative</label>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('pall-biotech-webinar-aug20')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/pall-biotech/index.blade.php ENDPATH**/ ?>