...
<head>
	...
	<title>Catalent Clinical Supply</title>

	<link rel="shortcut icon" href="<?php echo e(config('app.url')); ?>/images/favicon.ico" type="image/x-icon">

	<!-- Meta Tags -->
	<meta property="og:title" content="Catalent Clinical Supply" />
	<meta name="description" content="How to Optimize Clinical Trials with a Clinical Supply Management Strategy and EU Qualified Persons on How to Optimize Global Clinical Studies" />
	<meta name="keywords" content="" />

	<meta property="og:description" content="How to Optimize Clinical Trials with a Clinical Supply Management Strategy and EU Qualified Persons on How to Optimize Global Clinical Studies" />
	<meta property="og:Keywords" content="" />

	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/catalent/catalent-ondemand-banner.jpg" />
	<link rel="canonical" href="<?php echo e(url('catalent-webinar')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('catalent-webinar')); ?>" />
...
<?php if(view()->exists('webinars.banner')): ?>
  ...
  <?php endif; ?>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/catalent/catalent-logo.png" alt="Catalent" class="ml-2 img-fluid">
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/catalent/catalent-ondemand-banner.jpg" alt="Catalent Clinical Supply" title="Catalent Clinical Supply" class="img-fluid shadow" />
			</div>

      		<div class="col-lg-7 col-md-7 col-sm-12 col-12 pt-3">

				<h1 class="font-weight-bold PF-TXTRED font-18">How to Optimize Clinical Trials with a Clinical Supply Management Strategy</h1>

				<h2 class="text-primary">Thursday, <strong>28<sup>th</sup> May 2020</strong></h2>

				<p class="mt-2 mb-0">15:00 (GMT+8) | 15:00 (China & Singapore) | 16:00hrs (Japan) | 17:30hr (Sydney)</p>

      			<p>The day-to-day practice of clinical supply management (CSM) faces many challenges.  Clinical trials have multiple moving parts that must be proactively managed, including clinical supplies that need to be prepared well in advance of the actual study start. Supply delays, stock-outs or excess inventory are all undesirable and potentially risky scenarios. In recent years, clinical studies have become more global and increasingly complex, involving a multitude of clinical sites and network depots spanning multiple countries and geographic regions, each with a unique set of challenges and requirements. When more countries and regions are added or dropped during a study, CSM activities such as forecasting become important as they can plan for and guide an appropriate response to such changes.</p>  				
            </div> 

			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3 mb-3 align-self-center">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/catalent/catalent-video-thumb.jpg" alt="Video thumb" class="video img-fluid shadow border" />
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12 col-12 person"> 
				<div class="p-2 PF-BrdrDDD mb-2 mt-2 bg-sky shadow" align="center">	                      	
					<img src="<?php echo e(config('app.url')); ?>webinars/catalent/juliana-wang.jpg" alt="Juliana Wang" title="Juliana Wang" class="img-fluid rounded-circle border pt-2" />
					<div class="pt-2">
						<p class="person-name PF-TXTRED mb-1">Juliana Wang</p>
						<p class="gray-text mb-1"><em>Senior Clinical Supply Manager</em></p>
						<p class="mb-2 small">Asia Pacific Region</p>
					</div>                 
				</div> 
			</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-12 person"> 
				<div class="p-2 PF-BrdrDDD mb-2 mt-2 bg-sky shadow" align="center">	                      	
					<img src="<?php echo e(config('app.url')); ?>webinars/catalent/jan-phillips.jpg" alt="Jan Phillips" title="Jan Phillips" class="img-fluid rounded-circle border pt-2" />
					<div class="pt-2">
						<p class="person-name PF-TXTRED mb-1">Jan Phillips</p>
						<p class="gray-text mb-1"><em>Quality Director, Clinical Supply Services</em></p>
						<p class="mb-2 small">Bolton, UK</p>
					</div>                 
				</div> 
			</div>

			<div class="col-md-6 col-md-6 col-sm-12 col-12 pt-2">				
				<h2 class="font-weight-bold font-18 PF-TXTRED">The EU Qualified Person Process for Your Global Clinical Studies</h2>
				<p>The EU regulatory framework around clinical trials and the role of the EU Qualified Person can seem complex and challenging but are essential to understand if studies are to be successfully conducted in this important region.</p>

				<h2 class="font-weight-bold font-18 PF-TXTRED">In this webinar, Participants will learn about:</h2>
				<p>How experienced clinical supply chain managers can help sponsors develop more robust and proactive clinical supply plans, understand the critical role of the Qualified Person in EU clinical trials; and explore more customized solutions to clinical supply challenges for APAC customers.</p>
			</div>
		</div>            
	...
	<div class="container">	
		...
		<div class="row">
			<div class="col-md-12">
			  <h2 class="PF-TXTRED mt-3"><strong>About - Catalent Clinical Supply Services</strong></h2>
			  <p class="mb-3">Catalent is a global leader in clinical supply services, with comprehensive and flexible solutions for small molecules, biologics, and cell and gene therapies and integrated solutions to accelerate speed to clinic. Catalent offers a full range services including clinical supply management, comprehensive packaging solutions, comparator sourcing, cold chain storage and global distribution and specialized supply chain services including direct-to-patient and demand-led supply. With nine GMP clinical packaging facilities and over 50 strategically located depots on six continents combined with more than 25 years’ experience across thousands of studies in more than 80 countries, Catalent has the comprehensive services, global scale and expertise necessary to reliably supply clinical trials of all sizes and complexity anywhere in the world. </p>
			</div>
		</div>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?php echo e(url('catalent-webinar-success')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									...
									<input type="hidden" name="type" id="type" value="catalent-webinar-video" />
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label small" for="email_updates">I would like to receive email updates about Catalent Webinar products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label small" for="representative">I have more questions and would like to be contacted by a Catalent Webinar representative</label>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('catalent-webinar')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/catalent/index.blade.php ENDPATH**/ ?>