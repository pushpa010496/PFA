...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>images/oracle-health-sciences-virtual-og.jpg" />
...
<body>
	...
	<div class="container-fluid shadow">	
		<div class="row">
			<img src="<?php echo e(config('app.url')); ?>images/oracle-health-sciences-embrance-banner.jpg" alt="Oracle - AI Revolution in Multivigilance" class="img-fluid">
		</div>		
	</div>
...
for more than half of their trials.</p>
			...
			<div class="col-lg-4 col-12 pt-3 pb-4">
				...
				<div class="form-bg p-3"> 
					...
					<form action="<?php echo e(route('oracleExploreClinicaltrial.post')); ?>" method="post">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-seconadry" role="button" id="aa" name="aa"  href="<?php echo e(url('promotion/oracle-explore-clinicaltrial')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/flatpages/oracle-explore-clinicaltrial.blade.php ENDPATH**/ ?>