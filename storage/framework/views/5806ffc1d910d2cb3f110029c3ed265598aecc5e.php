      ...
      <table width="500" border="0" cellpadding="5">
        ...
        <?php if(@$first_name !=''): ?>
         ...
         <?php if(@$state != ''): ?> 
            ...
            <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">cQrex® peptides</td>
...
<td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Carbohydrates/ Bio-sugars</td>
...
<td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Veg Derived cholesterol</td>
...
<tr>
  ...
  <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Amino acids</td>
            ...
            <?php endif; ?>
                ...
                <?php if(@$email_updates != ''): ?>  
                  ...
                  <tr>
                    ...
                    <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Download Technical Documents</td>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/emails/flatpages/admin-enevonik.blade.php ENDPATH**/ ?>