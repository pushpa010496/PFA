		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/korber/koerber_logo.jpg" alt="yokogawa-webinar-logo" class="ml-2 img-fluid" />
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/korber/korbar-banner.jpg" alt="Yokogawa-Webinar" title="Yokogawa-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">Use cases of digitization in pharma & MES implementation in the Cloud </h2>

						<p class="font-weight-bold">The COVID-19 pandemic has forced pharma and healthcare industry worldwide to adopt digitization in order to become more resilient in these challenging times. By adopting digitalization, pharma manufacturers can significantly improve efficiency and effectiveness in their manufacturing processes. Effectiveness can be achieved by standardization while efficiency can be achieved by optimization. This will make entire supply chain lean by enhancing visibility into their production processes.In his presentation, Mr. Manoj Joshi will cover the use cases of digitization and why digital transformation in pharma has become unavoidable. </p>
						<p class="font-weight-bold">Cloud MES is changing the pharma IT landscape and end users are gradually shifting towards cloud MES as it’s easily scalable compared to on-premise MES. Moreover, digitization efforts accelerated by the global pandemic is increasing MES migration to the cloud. In his session, Mr. Orchun Thakral will talk about how pharma & biotech manufacturers can benefit from cloud MES. </p>
					</div>
				</div> 
			</div>
			
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/korber/korbar-ondemand-video-image.jpg" alt="Korber Webinar" title="Korber Webinar" class="img-fluid video shadow border text-center" />
				<div class="p-2 PF-BrdrDDD mb-1 bg-light shadow mt-4" align="center">
					<h3 class="pt-1 pb-1">
						<strong class="TXT-RED font-20">14<sup>th</sup> July 2021</strong>
						<span class="small text-secondary ml-2 mr-3">(Wednesday)</span>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/korber/JoshiManoj.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Mr. Manoj Joshi </strong></h2>
							<p class="gray-text mb-2"><em>General Manager – Operations Software, India </em></p>
							<p class="mb-1">Manoj Joshi is General Manager – Operations Software at Körber Medipak Systems India. He has over 25 years of experience in the Pharmaceutical Industry. Manoj has successfully delivered MES and SAP implementation/support projects in Global Pharmaceutical companies and also carries rich experience in USFDA Regulatory compliance and IT Governance. </p>
						</div> 
					</div>
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-12 col-12 person text-center">
							<h3 class="PF-TXTRED font-weight-bold font-18 text-uppercase mt-1">Speaker:</h3>
						<img src="<?php echo e(config('app.url')); ?>webinars/korber/orchun-thakral.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Mr. Orchun Thakral </strong></h2>
							<p class="gray-text mb-2"><em>Dept.General Manager&Head of Sales Software (Asia Pacific), Thailand </em></p>
							<p class="mb-1">Orchun is the Dept. General Manager & Head of Sales (Asia Pacific) at Körber Business Area Pharma. Orchun is a highly experienced Manufacturing Execution Systems (MES) technical expert and consultant with a track record of proven success in critical MES projects for the Biotech and Pharmaceutical industry. </p>
							<p class="mb-1">His background is in Computer Engineering and he has been deeply involved for over 10 years with important MES projects for clients including: AstraZeneca (Sweden), AstraZeneca (India), AstraZeneca (UK), Dr Reddy’s (India), CibaVision (Singapore), Kalbe Farma (Indonesia) and MSD (Singapore) before moving into his current Sales role. </p>
						</div> 
					</div>
				</div>
			</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo e(route('korberpharmawebinar.post')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12 mb-2">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
								    ...
								    <input type="hidden" name="type" id="type" value="On-demand Korber Pharma Webinar ">
                    									
                                    <input type="hidden" name="formtype" value="modal-form">
                                    
                                    <input type="hidden" name="thank_message" value="Your On-demand Korber Pharma Webinar  registration was successfully completed.">
                                    
                                    <input type="hidden" name="client_message" value="Thank you for showing your interest in Korber Pharma Webinar ">
							...
							<div class="col-md-12 mb-2">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="email_updates">I would like to receive email updates about Korber Pharma webinar products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="representative">I have more questions and would like to be contacted by a Korber Pharma webinar representative</label>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('korber-webinar')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/korberpharma-webinar/index.blade.php ENDPATH**/ ?>