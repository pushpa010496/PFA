...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>images/thermo-fisher-banner-og.jpg" />
	<link rel="canonical" href="<?php echo e(URL::current('thermo-fisher-scientific')); ?>" />
...
<body>
	<div class="container-fluid">
		<div class="container">
			<div class="row">
				...
				<img src="<?php echo e(config('app.url')); ?>images/thermo-fisher-scientific-logo.jpg" alt="thermo-fisher-scientific_logo" title="thermo-fisher-scientific_logo" class="img-fluid mt-1 mb-1" >
				</div>
	...
	<div class="container shadow mb-3">
		<div class="row position-relative">
			...
			<img class="w-100" src="<?php echo e(config('app.url')); ?>images/thermo-fisher-banner-1.png" alt="bioaccord-banner" title="bioaccord-banner" class="img-fluid">
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="col-12 col-md-3 " >
				<p class="shadow font-weight-bold BG-BLUE pt-2 text-white text-center font-18 py-2 px-1 rounded" data-toggle="modal" data-target="#myForm" style="cursor: pointer;">Download Now</p>
			</div>
	   </div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content BG-BLUE">
				...
				<div class="modal-body">
            		<form action="<?php echo e(route('thermoFisherScientific.post')); ?>" method="post" id="writemessage">
            		   <?php echo csrf_field(); ?>   
            		   <div class="row">
            ...
            <textarea class="form-control rounded-0" id="exampleFormControlTextarea1" rows="2" name="message"></textarea>
				...
				<input type="checkbox" class="custom-control-input" name="declaration" value="yes" id="product-interest-33" checked>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a class="btn btn-seconadry" role="button" id="aa" name="aa" href="<?php echo e(url('promotion/thermo-fisher-scientific')); ?>" aria-expanded="false">
						Close
					</a>
				</div>
			</div>
...
</html><?php /**PATH /home/pharmafocusasia/public_html/resources/views/flatpages/thermo-fisher-scientific.blade.php ENDPATH**/ ?>