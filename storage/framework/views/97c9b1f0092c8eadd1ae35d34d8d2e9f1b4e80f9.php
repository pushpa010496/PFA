...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/bc-platforms/bc-platforms-utilizing-nordic-hospital-data-lakes-og.jpg" />

	<link rel="canonical" href="<?php echo e(url('bc-platforms-presentation')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('bc-platforms-presentation')); ?>" />
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-8 col-7 my-auto offset-lg-5 offset-md-5 pt-2 pb-2 text-right gray-text align-self-center">
					<p class="mb-0">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/bc-platforms/bc-platforms-logo.jpg" alt="bc-platforms" class="ml-2 img-fluid">
					</p>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/bc-platforms/bc-platforms-utilizing-nordic-hospital-data-lakes-banner.jpg" alt="bc-platforms" title="bc-platforms" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 person pt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/bc-platforms/bcplatforms-video-thumb.jpg" alt="BC Platforms Webinar Video" title="BC Platforms Webinar Video" class="img-fluid video shadow border text-center" />		
			</div> 		
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo e(route('bcPlatformsPresentation.post')); ?>" method="post" id='writemessage' >
							...
							<div class="row">
								...
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
										<input class="form-control" id="name" name="lastname" placeholder="Last Name *" required=""  value="<?php echo e(old('name')); ?>"  type="text">
										<span class="help-block"><?php echo e($errors->first('name', ':message')); ?></span>
									</div>
								</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/nordic-hospitals/index.blade.php ENDPATH**/ ?>