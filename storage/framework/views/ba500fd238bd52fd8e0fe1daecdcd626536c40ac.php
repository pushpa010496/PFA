...
<head>
	...
	<title>TOC in Pharmaceuticals - Are you ahead of Pharmacopoeia compliance and expectations?</title>

	<link rel="shortcut icon" href="<?php echo e(config('app.url')); ?>/images/favicon.ico" type="image/x-icon">


	<!-- Meta Tags -->
	<meta property="og:title" content="TOC in Pharmaceuticals - Are you ahead of Pharmacopoeia compliance and expectations?" />
	<meta name="description" content="Join this interactive webinar to learn about various application areas where TOC monitoring can help comply with global regulations and improve efficiency." />
	<meta name="keywords" content="" />

	<meta property="og:description" content="Join this interactive webinar to learn about various application areas where TOC monitoring can help comply with global regulations and improve efficiency." />
	<meta property="og:Keywords" content="" />

	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/suez-webinar-og.jpg" />
	<link rel="canonical" href="<?php echo e(url('suez-toc-webinar')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('suez-toc-webinar')); ?>" />
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 person">
				<img src="<?php echo e(config('app.url')); ?>webinars/sueztocwebinar/suez-toc-webinar-banner-full.jpg" alt="suez" title="suez" class="img-fluid shadow" />
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-12 col-12">	
				<div class="row">
              		<div class="col-lg-4 col-md-4 col-sm-12 col-12 person pt-3">
      					<div class="row">
      						<!-- <div class="col-md-12 text-center">
      							<a href="http://add.eventable.com/events/5d0486d9da647d007d0101e4/5d0486dc87709a001ed8bbb2/" class="eventable-link" target="_blank" data-key="5d0486d9da647d007d0101e4" data-event="5d0486dc87709a001ed8bbb2" data-style="1">Add to Calendar</a>
      							<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://plugins.eventable.com/eventable.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script', 'eventable-script');</script>
      						</div> -->
      					</div> 

              			<div class="p-2 PF-BrdrDDD mb-3 mt-4 bg-white shadow" align="center">	                      	
							<h2 class="mb-1 pt-2 PF-TXTRED"><strong>23 July 2019</strong></h2>
							<p class="small mb-1"><strong>(Tuesday)</strong></p>
							<p class="mb-1 mt-2">11AM IST</p>
	                        ...
	                        <div class="pt-2">
	                          ...
	                          <p class="mb-0">Lead Product Application Specialist- APAC</p>	                          
	                          <p class="PF-TXTRED mb-2">rohit.chakravorty@suez.com</p>		                          
	                        </div>                   
                      	</div> 
              		</div> 
              		...
              		<div class="col-lg-8 col-md-8 col-sm-12 col-12 person pt-3">  
              			...
              			<p>Join this interactive webinar to learn about various application areas where TOC monitoring can help comply with global regulations and improve efficiency. Participants will learn how to further increase their process understanding and identify the importance of TOC for existing/upcoming water systems. In addition to discussing compendia testing for TOC in UPW, participants will hear how companies are implementing cleaning validation in the lab/at-line/on-line and for compliance with leachables and extractables of plastic packaging systems as per USP<661> and IP <6.2> 2018 edition.This webinar is an excellent course for those wanting to get ahead of compliance and expectations. </p>

          				<h3><strong>In this webinar, participants will learn about:</strong></h3> 
          				<ul style="list-style-type: disc;padding-left: 20px; ">
          					<li>Application areas of TOC in the pharma industry</li>
          					<li>Pharmacopeia compendia for TOC in UPW</li>
          					<li>Releasing water Real Time (RTRT)</li>
          					<li>Monitoring leachables and extractables in plastics used for packaging pharmaceutical products as per USP <661> and IP <6.2> 2018 edition</li>
      						<li>Use of TOC for cleaning validation</li>
      						<li>Replacing specific methods like HPLC with non-specific methods like TOC & conductivity for cleaning validation</li>
      					</ul>
                    </div> 
                </div>               
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-12 pt-3">
				<!-- <div class="BG-BLUE p-3">
					<h2 class="modal-title text-white font-weight-bold text-center mb-2">Free Registration</h2>
					<form action="<?php echo e(url('suez-toc-webinar-success')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									...
									<input type="hidden" name="type" id="type" value="suez-toc-webinar" />
							...
							<div class="col-md-12">
								<div class="form-group <?php echo e($errors->first('email', 'has-error')); ?>">
									<input class="form-control" id="email" name="email" placeholder="Email *" required=""  value="<?php echo e(old('email')); ?>"  type="name">
							...
							<div class="col-md-12">
								<div class="form-group  <?php echo e($errors->first('state', 'has-error')); ?>">
									<select class="form-control" id="state" name="state" placeholder="state *"  value="<?php echo e(old('state')); ?>" >
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-white small" for="email_updates">I would like to receive email updates about SUEZ products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
										<input type="checkbox" class="custom-control-input" name="quotation" value="Yes" id="quotation" checked>
										<label class="custom-control-label text-white small" for="quotation">I would like to request a quotation</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
										<input type="checkbox" class="custom-control-input" name="representative" value="Yes" id="representative" checked>
										<label class="custom-control-label text-white small" for="representative">I have more questions and would like to be contacted by a SUEZ representative</label>
									</div>
								</div>
							</div>
				...
				<!-- <a href="https://attendee.gotowebinar.com/register/4230220755301645826" target="_blank" class="btn btn-block btn-lg btn-success shadow"><i class="fa fa-desktop mr-2" aria-hidden="true"></i> <strong>On-Demand Webinar</strong></a> -->

				<div class="text-center">
					<img type="button" class="video img-fluid" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/sueztocwebinar/suez-toc-pharmaceuticals-thumb.jpg" />
				</div>
		             ...
		             <div class="bg-light border p-3">
		                <h2 class="PF-TXTRED mt-0"><strong>Who should Attend:</strong></h2>
		                 <ul class="mb-0" style="list-style-type: disc;padding-left: 20px">
							<li>QA & QC personnel in the Pharmaceutical Industry</li>
							<li>Validation personnel in the Pharmaceutical Industry</li>
							<li>Operations personnel in the Pharmaceutical Industry</li>
							<li>Engineering teams in the Pharmaceutical Industry</li>
		                </ul>
		             </div>
		        </div>
			</div>
	...
	<div class="container">	
		<div class="row">
	        <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 align-self-center">
	            ...
	            <p class="text-center mb-0 font-16">This is the 3rd webinar in the series conducted by "Suez" organised by Pharma Focus Asia.</p>
	          </div>
	        </div>
	    </div>
		...
		<div class="row">
			<div class="col-md-12">
			  ...
			  <p>Rohit is the Lead Application Specialist with SUEZ(erstwhile GE Water, GE Analytical Instruments) responsible for providing application support in India, SAARC and ASEAN region for the Sievers product line. He is responsible for helping the pharmaceutical industry become familiar with TOC applications, notably in cleaning validation and Real-Time-Release-Testing (RTRT) of pharmaceutical water. Rohit is experienced in guiding customers in successful transitions from HPLC to TOC for cleaning validation. The work involves TOC limit calculations and optimizing protocols for soluble and insoluble API.</p>
			  ...
			  <p>Rohit holds a Masters in Biotechnology (Gold Medalist) from Padmashree Dr. D.Y.Patil University in India.</p>
			</div>
		</div>
	</div>	
		...
		<div class="modal-dialog modal-sm">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h2 class="modal-title text-blue">Free Registration to view now</h2>
					...
					<form action="<?php echo e(url('suez-toc-webinar-success')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									<input class="form-control" id="name" name="name" placeholder="Full Name *" required=""  value="<?php echo e(old('name')); ?>"  type="text">	
									<input type="hidden" name="type" id="type" value="suez-toc-webinar-video" />
									<input type="hidden" name="formtype"  value="modal-form" />
									<span class="help-block"><?php echo e($errors->first('name', ':message')); ?></span>
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group <?php echo e($errors->first('zip', 'has-error')); ?>">
									<input type="text" class="form-control" id="zip" name="zip" placeholder="ZIP *" value="<?php echo e(old('zip')); ?>" required/>
									<span class="help-block"><?php echo e($errors->first('zip', ':message')); ?></span> 
								</div>
							</div> -->	
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										<input type="checkbox" class="custom-control-input" name="email_updates" value="Yes" id="email_updates">
										<label class="custom-control-label small" for="email_updates">I would like to receive email updates about SUEZ products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label small" for="representative">I have more questions and would like to be contacted by a SUEZ representative</label>
									</div>
								</div>
							</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">				
					<div class="modal-body">
						...
						poster="<?php echo e(config('app.url')); ?>webinars/sueztocwebinar/suez-toc-pharmaceuticals-thumb.jpg" data-setup='{}'>
						<source src="<?php echo e(config('app.url')); ?>webinars/sueztocwebinar/suez-toc-pharmaceuticals-are-you-ahead-of-pharmacopoeia-compliance-and-expectations.mp4" type='video/mp4'>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">        
					<a class="btn btn-primary" role="button"  href="<?php echo e(url('suez-toc-webinar')); ?>" aria-expanded="false">
						Close
					</a>         
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/sueztocwebinar/index.blade.php ENDPATH**/ ?>