...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(config('app.url')); ?>css/single-style.css">
      ...
      <header class="large">
        <nav>
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" align="center">
            <img src="<?php echo e(config('app.url')); ?>images/logo.png" class="img-fluid logo" alt="<?php echo e(trans('messages.sitename')); ?>" title="<?php echo e(trans('messages.sitename')); ?>">
          </div> 
            ...
            <div class="row">
              <div class="col-lg-8 col-xs-12 pl-0 mt-4">                
                <div class="row">
                  <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12 p-0 pt-3" align="center">
                      ...
                      <img src="<?php echo e(config('app.url')); ?>images/3-magazine.png" alt="e-Book" class="img-fluid mb-2">
                  </div>
              ...
              <div class="col-lg-4 col-xs-12 form-bg mt-3">
                <div class="p-3">
                  ...
                  <form role='form' action="<?php echo e(route('printads.post')); ?>" method="post" accept-charset="utf-8" class="email" id="writemessage">  
	...
	<div class="container pt-4">
        ...
        <div class="tabs">
          ...
          <div id="tab01" class="tab-contents">
            <img src="<?php echo e(config('app.url')); ?>images/pfa-geographical-breakdown.jpg" alt="Target Market" class="img-fluid pt-3 pb-4">
          </div>
          <div id="tab02" class="tab-contents">
            <img src="<?php echo e(config('app.url')); ?>images/pfa-occupational-break-down.jpg" alt="Target Audience" class="img-fluid pt-3 pb-4"> 
          </div>
        </div>
        ...
        <div id="testimonials-carousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-1.jpg" alt="Testimonial">
            ...
            <div class="carousel-item">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-2.jpg" alt="Testimonial">
               <div class="carousel-caption text-left">
                <div class="bg-blk-transp p-4">
            ...
            <div class="carousel-item">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-3.jpg" alt="Testimonial">
               <div class="carousel-caption text-left">
                <div class="bg-blk-transp p-4">
            ...
            <div class="carousel-item">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-4.jpg" alt="Testimonial">
              <div class="carousel-caption text-left">
                <div class="bg-blk-transp p-4">
            ...
            <div class="carousel-item">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-5.jpg" alt="Testimonial">
               <div class="carousel-caption text-left">
                <div class="bg-blk-transp p-4">
            ...
            <div class="carousel-item">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-6.jpg" alt="Testimonial">
              <div class="carousel-caption text-left">
                <div class="bg-blk-transp p-4">
            ...
            <div class="carousel-item">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-7.jpg" alt="Testimonial">
              <div class="carousel-caption text-left">
                <div class="bg-blk-transp p-4">
            ...
            <div class="carousel-item">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-8.jpg" alt="Testimonial">
              <div class="carousel-caption text-left">
                <div class="bg-blk-transp p-4">
            ...
            <div class="carousel-item">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-9.jpg" alt="Testimonial">
              <div class="carousel-caption text-left">
                <div class="bg-blk-transp p-4">
            ...
            <div class="carousel-item">
              <img class="img-fluid" src="<?php echo e(config('app.url')); ?>images/testimonial-slide-10.jpg" alt="Testimonial">
              <div class="carousel-caption text-left">
                <div class="bg-blk-transp p-4">
                  <h5 class="txt-yellow mt-0"><strong>Brian D Smith</strong></h5>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/cms/printadvertise/index.blade.php ENDPATH**/ ?>