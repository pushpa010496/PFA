    ...
    <td>
      ...
      <table width="500" border="0" cellpadding="5">
        ...
        <?php if(@$current_project != ''): ?>
            ...
            <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Are you interested in requesting a product sample for the POROS HIC chromatography resins in your lab?</td>
            ...
            <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Are you interested in receiving a quote for the POROS HIC chromatography resins in your lab?</td>
            ...
            <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">job_role</td>
            ...
            <?php endif; ?>
                ...
                <?php if(@$email_updates != ''): ?>  
                  ...
                  <tr>
                    ...
                    <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Are you interested in receiving a quote for the following products in your lab?</td>
                  ...
                  <tr>
                    ...
                    <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Are you interested in testing a product sample for the following products in your lab?</td>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/emails/flatpages/admin_antibody.blade.php ENDPATH**/ ?>