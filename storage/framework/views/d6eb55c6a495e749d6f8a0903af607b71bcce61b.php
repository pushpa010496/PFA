        ...
        <div class="row PF-MobP030">
          ...
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active PF-TXTRED" aria-current="page"><?php echo e(trans('messages.archives_title')); ?></li>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="PF-BrdrBEEE col-lg-12 col-md-12 col-sm-12 col-12 p-0 mb-3">
                  ...
                  <h1 class="PF-Bshelf pt-2"><?php echo e(trans('messages.archives_title')); ?></h1>            

                </div>

                <p><?php echo e(trans('messages.archives_text')); ?> </p>
                ...
                <div class="row">
                  ...
                  <div class="col BookList mb-2">
                    ...
                    <div class="card shadow" style="width:180px !important;">                    
                      ...
                      <a id="show_confirm" data-toggle="modal" href="#" data-target="#modal_confirm" data-id ="<?php echo e(Str::slug($book->issue->id)); ?>" data-eid ="<?php echo e($book->id); ?>" data-title ="<?php echo e($book->issue->issue_no); ?>">

                        <img src="<?php echo e(config('app.url').'ebooks/'. Str::slug($book->issue->issue_no).'/'.$book->magazine_image); ?> " alt="" title="" class="img-fluid">
                      ...
                      <!--    <div class="card-text pt-2 pb-3 pr-1">
                            ...
                            <ul>
                              ...
                              <?php $__currentLoopData = $book->issue->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="modal-body">
        ...
        <form action="" method="post" accept-charset="utf-8">
          ...
          <div class="input-group">
            ...
            <input type="hidden" value="<?php echo e(old('action')); ?>" name="action">
...
<script>
  ...
  <?php if($errors->any()): ?>      
      ...
      $(document).ready(function(){ 
        ...
        $("form").attr('action',"<?php echo e(old('action')); ?>");  
...
$('body').on('click','#show_confirm', function (event) {
  ...
  var action = "<?php echo e(url('archives-magazine')); ?>" +'/' + issue_id;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/magazine/archives/index.blade.php ENDPATH**/ ?>