...
<body>
    <!-- <form id="elqForm" action="https://secure.eloqua.com/e/f2" method="GET" target="postFrame"> -->
        <form id="elqForm" action="<?php echo e(route('PharmaMachineryAssessment.post')); ?>" method="post" target="postFrame">
            <?php echo csrf_field(); ?>
                ...
                <table cellspacing="0" cellpadding="0" border="0" class="table">
                    <tr>
                        ...
                        <td id="progress16" data-panel="question16" class="inactive">
                            ...
                            <img src="<?php echo e(config('app.url')); ?>zebra/img/progress-16.png" class="inactive">
                        </td>
                    </tr>
                </table>
...
</html><?php /**PATH /home/pharmafocusasia/public_html/resources/views/flatpages/pharma-machinery-assessment.blade.php ENDPATH**/ ?>