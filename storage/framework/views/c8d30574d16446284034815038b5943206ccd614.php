  ...
  <div class="container pt-4 pb-5"> 
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 pt-3 pb-3" align="center">
          ...
          <a href="<?php echo e(url('subscribe')); ?>" target="_blank">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 pt-3 pb-3" align="center">
          ...
          <a href="<?php echo e(url('latest-ebook')); ?>" target="_blank">
            ...
            <div id="block" class="p-3 teal-blue-block transition">
              ...
              <span class="text-center PF-TXTBlk"><?php echo e(trans('messages.siteshortname')); ?> latest E-book provides systematic approaches to enhance quality pharma detailing the recent technologies.</span>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 pt-3 pb-3" align="center">
          ...
          <a href="<?php echo e(url('editorial-calendar')); ?>" target="_blank">
            ...
            <div id="block" class="p-3 green1-block transition">
              ...
              <span class="text-center PF-TXTBlk">Our editorial calendar provides focused coverage of <?php echo e(trans('messages.siteshortname')); ?> Issues covering emerging trends in the pharma industry. </span>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 pt-3 pb-3" align="center">
          ...
          <a href="<?php echo e(url('mediapacks')); ?>" target="_blank">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 pt-3 pb-3" align="center">
          ...
          <a href="<?php echo e(url('post-event')); ?>" target="_blank">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 pt-3 pb-3" align="center">
          ...
          <a href="<?php echo e(url('e-newsletter-subscribe')); ?>" target="_blank">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/forms/register.blade.php ENDPATH**/ ?>