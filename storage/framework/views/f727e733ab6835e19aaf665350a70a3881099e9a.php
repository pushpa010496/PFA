                ...
                <ul class="media-list col-md-12 p-0" id="main_content">               
                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($tempmonth !=$dd): ?>
                      ...
                      <h2 class="text-uppercase PF-BrdrBbbbdc2 pb-1 PF-TXTRED"><?php echo e($dd); ?><span class="PF-IntigerStyle"></span></h2>
                      <?php $tempmonth = $dd;  ?>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/events/index.blade.php ENDPATH**/ ?>