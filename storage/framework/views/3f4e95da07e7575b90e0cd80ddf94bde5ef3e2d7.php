...
<head>
	...
	<title>Making the Change: How to prepare for the future of clinical trials? | Oracle | Series-1 | English</title>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/oracle/series1/oracle-series1-ondemand-banner-en.jpg" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="<?php echo e(config('app.url')); ?>webinars/oracle/series1/english-ondemand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/oracle/series1/english-videosuccess.blade.php ENDPATH**/ ?>