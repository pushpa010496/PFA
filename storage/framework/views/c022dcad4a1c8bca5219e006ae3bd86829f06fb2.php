...
<div id="myModal" class="modal fade" role="dialog">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" role="button" id="aa" name="aa" href="<?php echo e(url('https://www.pharmafocusasia.com/subscribe')); ?>"
		...
		<form action="<?php echo e(url('magazine-subscribe1-post')); ?>" method="Post" enctype="multipart/form-data">	
<?php echo csrf_field(); ?>
...
<script>
  ...
  <?php endif; ?> 
	...
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/forms/subscribe/index-new.blade.php ENDPATH**/ ?>