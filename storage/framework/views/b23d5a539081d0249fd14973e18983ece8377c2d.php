...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/solovpe/solovpe-webinar-og.jpg" />

	<link rel="canonical" href="<?php echo e(url('solovpe-webinar')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('solovpe-webinar')); ?>" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/solovpe/solovpe-webinar-logo.png" alt="solovpe-webinar logo" class="ml-2 img-fluid"> 
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/solovpe/solovpe-webinar-banner.jpg" alt="solovpe-webinar" title="solovpe-webinar" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/solovpe/solovpe-webinar-video-thumb.jpg" alt="solovpe" title="solovpe" class="img-fluid video shadow border text-center" />
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-12 col-12 person"> 
				<div class="p-2 PF-BrdrDDD mb-2 mt-2 bg-sky shadow" align="center">	 
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/solovpe/solovpe-webinar-speaker.jpg" alt="徐天闻" title="徐天闻" class="img-fluid rounded-circle pt-2">
					<div class="pt-2">
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo e(url('solovpe-webinar-success')); ?>" method="post" id='writemessage' >
							<?php echo e(csrf_field()); ?>

							<div class="row">
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('firstname', 'has-error')); ?>">
										<input class="form-control" id="firstname" name="firstname" placeholder="名字 *" required=""  value="<?php echo e(old('name')); ?>"  type="text">	
								...
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('lastname', 'has-error')); ?>">
										<input class="form-control" id="lastname" name="lastname" placeholder="姓 *" required=""  value="<?php echo e(old('name')); ?>"  type="text">
									</div>
								</div>
								...
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('job_title', 'has-error')); ?>">
										<input class="form-control" id="job_title" name="job_title" placeholder="职称 *"  value="<?php echo e(old('job_title')); ?>"  required="" type="text">
								...
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('address', 'has-error')); ?>">
										<input class="form-control" id="address" name="address" placeholder="地址 *"  value="<?php echo e(old('address')); ?>"  required="" type="text">
								...
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('city', 'has-error')); ?>">
										<input class="form-control" id="city" name="city" placeholder="市 *"  value="<?php echo e(old('city')); ?>"  required="" type="text">
								...
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('email', 'has-error')); ?>">
										...
										<input type="email" class="form-control"  name="email" id="email" value="<?php echo e(old('email')); ?>" pattern="^[^@]+@(?!(qq.com|163.com))[^@]+\.[a-z]{2,}$" title="Please enter valid  email id" placeholder="电子邮件 *" required="required">
								...
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('phone', 'has-error')); ?>">
										<input class="form-control" id="phone" name="phone" placeholder="电话 *" required=""  value="<?php echo e(old('phone')); ?>"  type="text">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('solovpe-webinar')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/solovpe-webinar/index.blade.php ENDPATH**/ ?>