...
<head>
	...
	<title>Eppendorf Bioprocess Webinar</title>
	...
	<meta property="og:title" content="Eppendorf Bioprocess Webinar" />
	<meta property="og:description" content="" />
	<meta property="og:Keywords" content="" />

	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/eppendorf-bioprocess/eppendorf-og-ondemand.jpg" />

	<link rel="canonical" href="<?php echo e(url('eppendorf-bioprocess-webinar')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('eppendorf-bioprocess-webinar')); ?>" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/eppendorf-bioprocess/eppendorf-logo.png" alt="Eppendorf" class="ml-2 img-fluid">
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/eppendorf-bioprocess/eppendorf-banner-ondemand.jpg" alt="Eppendorf" title="Eppendorf" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12 person pt-3">
				<h2 class="font-weight-bold PF-TXTRED font-18">Webinar: From shaker to fermenter</h2> 

      			<p class="mb-1">Shake flasks, cell culture dishes, and T-flasks are the first vessels that come to mind when we think about cultivation systems for growing eukaryotic and prokaryotic cells in the lab. Bioreactors and fermenters open up new possibilities and are another alternative to consider if we need larger quantities of cells, increased efficiency of cultivation, or enhanced reproducibility.</p>
      			<p>Within this webinar, the participants will learn the differences between the cultivation of cells in shakers and bioreactors. We will focus on the basic components of a bioreactor and the various process parameters that can be controlled. Finally, we will focus on different process strategies to further optimize a process and increase production.</p>

  				<h3 class="font-weight-bold font-18 PF-TXTRED">Key learnings:</h3> 
  				<ul style="list-style-type: decimal; padding-left: 20px; line-height: 1.3;">
					<li>Review: Why to switch from shake flasks to stirred-tank bioreactors</li>
					<li>Learn, what are the basic components of a bioreactor</li>
					<li>Learn about the different process parameters that can be monitored and controlled, and what they tell you about your culture.</li>
					<li>Learn about feeding possibilities in shake flasks & bioreactors and their impact on your culture</li>
					<li>Live “Ask the Expert” session – Deepen your knowledge and optimize your process</li>
  				</ul>

  				<h3 class="font-weight-bold font-18 PF-TXTRED">Audience</h3> 
  				<ul style="list-style-type: decimal; padding-left: 20px; line-height: 1.3;">
					<li>Beginners, who consider switching from shake flasks to a bioreactor;</li>
					<li>Early bioreactor users, who want to deepen their knowledge and understanding of the possibilities of bioreactors</li>
  				</ul>
			</div>			

      		<div class="col-lg-5 col-md-5 col-sm-12 col-12 person pt-3">
      			<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/eppendorf-bioprocess/eppendorf-video-thumb.jpg" alt="Eppendorf Webinar Video" title="Eppendorf Webinar Video" class="img-fluid video shadow border text-center" />		

      			<div class="row">
	      			<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-4">
	      				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow" align="center">
	      					<h2 class="pt-2 PF-TXTRED"><strong>15<sup>th</sup> September 2020</strong>  <span class="small"><strong>(Tuesday)</strong></span></h2>	      					
	      					<p class="mb-1 mt-2 font-14">08:00 hrs (Germany) | 11:30 hrs (India)</p>
	      					<p class="font-14">14:00 hrs (Singapore) | 16:00 hrs (Sydney)</p>

	      					<img src="<?php echo e(config('app.url')); ?>webinars/eppendorf-bioprocess/joerg-schwinde.jpg" alt="Joerg Schwinde" title="Joerg Schwinde" class="img-fluid rounded-circle border" width="100" />	      					
      						<p class="font-18 PF-TXTRED mt-1 mb-0">Joerg Schwinde</p>
      						<p class="gray-text mb-1"><em>Eppendorf AG - Bioprocess Center</em> | Juelich, Germany</p>
	      				</div> 
	      			</div>	
      			</div>	
            </div> 		
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo e(url('eppendorf-bioprocess-webinar-success')); ?>" method="post" id='writemessage' >
							...
							<div class="row">
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
										...
										<input type="hidden" name="type" id="type" value="Eppendorf Bioprocess On-demand Webinar" />
										<input type="hidden" name="formtype"  value="modal-form" />
										<input type="hidden" name="thank_message" value="Your registration for <strong>Eppendorf Bioprocess Webinar</strong> is successful. One of our team will get back to you soon and the details will be e-mailed to you.">
										<input type="hidden" name="client_message" value="Thank you for showing interest in the Eppendorf Bioprocess Webinar. The live link will be available a few hours prior to the webinar. As a reminder to the webinar you may receive a call from one of our associates before the webinar begins - so that you
										don't miss it.">
								...
								<div class="col-md-12 mb-2">
									<div class="form-group">
										<div class="custom-control custom-checkbox mb-1">
											...
											<label class="custom-control-label small" for="email_updates">I would like to receive email updates about Eppendorf products, services and events</label>
										</div>
										<div class="custom-control custom-checkbox mb-1">
										...
										<div class="custom-control custom-checkbox mb-1">
											...
											<label class="custom-control-label small" for="representative">I have more questions and would like to be contacted by a Eppendorf representative</label>
										</div>
									</div>
								</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('eppendorf-bioprocess-webinar')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/eppendorf-bioprocess/index.blade.php ENDPATH**/ ?>