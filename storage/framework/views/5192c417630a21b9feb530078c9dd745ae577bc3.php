        ...
        <div class="row PF-MobP030">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active PF-TXTRED text-capitalize" aria-current="page"><?php echo e(trans('messages.pressreleases_title')); ?></li>
            </ol>
          </nav>
        </div>
        ...
        <div class="row PF-WytBG">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 pb-2">
                <div class="PF-BrdrBEEE col-lg-12 col-md-12 col-sm-12 col-12 p-0 mb-3">
                 <h1 class="PF-Bshelf pt-2"><?php echo e(trans('messages.pressreleases_title')); ?></h1>              
                </div>
               <p><?php echo e(trans('messages.pressreleases_text')); ?></p>
              </div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 PF-P0">
                <nav>
                 ...
                 <ul class="pagination PF-M0 PF-PT10">
                  <li> <a href="<?php echo e(url('/').'/listpressreleases/year/'.date('Y')); ?>" class="PF-BrdrRds0 PF-TXTBlk PF-PointerEvents"> Archives - <span class="PF-IntigerStyle"><?php echo e(date('Y')-1); ?></span></a> </li>
                  ...
                  <li><a href="<?php echo e(url('/')); ?>/listpressreleases/month/<?php echo e($key); ?>/year/<?php echo e(date('Y')-1); ?>" class="PF-BrdrRds0"><?php echo e($value); ?></a></li>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>              
                <ul class="pagination PF-M0 PF-PT10">
                  <li> <a href="<?php echo e(url('/')); ?>/listpressreleases/year/<?php echo e(date('Y')); ?>" class="PF-BrdrRds0 PF-TXTBlk PF-PointerEvents"> Archives - <span class="PF-IntigerStyle"><?php echo e(date('Y')); ?></span></a> </li>
                  <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                  <?php if($key <= date('n')): ?>
                  <li><a href="<?php echo e(url('/')); ?>/listpressreleases/month/<?php echo e($key); ?>/year/<?php echo e(date('Y')); ?>" class="PF-BrdrRds0"><?php echo e($value); ?></a></li>
                  <?php else: ?>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 title-list">
                <h2 class="mb-0 PF-TXTBlk000">
                  <a href="<?php echo e(route('pressreleases.url',[$val->url])); ?>" title="<?php echo e($val->img_title); ?>" class="PF-TXTBlk000"><?php echo e($val->title); ?></a>
                </h2>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 d-none d-sm-block text-center">               
              <div class="bg-gray border-secondary">
                ...
                <a href="<?php echo e($homebanner12->url); ?>" target="_blank" class="mb-3" title="<?php echo e($homebanner12->title); ?>"><img class="img-fluid div-shadow mb-3" src="  <?php echo e(config('app.url') .'slider/'.$homebanner12->image); ?>" alt="" /></a>
...
<script type="text/javascript">
 var url = "<?php echo e(url('listpressreleases/month').'/'.$month .'/year/'.$year); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/pressreleases/filter.blade.php ENDPATH**/ ?>