...
<head>
    ...
    <meta property="og:image" content="<?php echo e(config('app.url')); ?>images/accelerating-mrna-research-and-manufacturing-og.jpg" />
    <link rel="canonical" href="<?php echo e(URL::current('accelerating-mrna-research-and-manufacturing')); ?>" />
        ...
        <div class="row position-relative">
            ...
            <div class="row m-0">
                <div class="col-12 col-md-6">
                    <img src="<?php echo e(config('app.url')); ?>images/accelerating-mrna-research-and-manufacturing-banner-1.png" alt="accelerating-mrna-research-and-manufacturing" title="accelerating-mrna-research-and-manufacturing" class="img-fluid">
                </div>
                <div class="col-12 col-md-6">
                    <img src="<?php echo e(config('app.url')); ?>images/accelerating-mrna-research-and-manufacturing-banner-2.png" alt="accelerating-mrna-research-and-manufacturing" title="accelerating-mrna-research-and-manufacturing" class="img-fluid">
                </div>
                    ...
                    <div class="col-12 col-md-4 col-lg-3">
                        <div class="card mb-3" style="height: calc(100% - 1rem);">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <img src="<?php echo e(config('app.url')); ?>webinars/<?php echo e($agenda[3]); ?>.jpg" style="width:140px;" class="img-fluid">
                                        <h6 class="card-title d-inline-block m-0 bg-danger px-1 rounded mr-2 text-white">
                                            <?php echo e($agenda[0]); ?>

                                        </h6>

                                        <h6 class="card-title"><?php echo e($agenda[1]); ?></h6>
                                    </div>
                                </div>
                                <h5 class="card-text"><?php echo e($agenda[2]); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12 text-center">
                            <div class="card mb-3" style="cursor:pointer;height: calc(100% - 1rem);" data-toggle="modal" data-target="#speaker1">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="<?php echo e(config('app.url')); ?>webinars/accelerating-mrna-speaker-1.jpg" alt="Henrik Ihre" title="Henrik Ihre" class="img-fluid">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12 text-center">
                            <div class="card mb-3" style="cursor:pointer;height: calc(100% - 1rem);" data-toggle="modal" data-target="#speaker2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="<?php echo e(config('app.url')); ?>webinars/accelerating-mrna-speaker-2.jpg" alt="Eylot Lam" title="Eylot Lam" class="img-fluid">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12 text-center">
                            <div class="card mb-3" style="cursor:pointer;height: calc(100% - 1rem);" data-toggle="modal" data-target="#speaker3">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="<?php echo e(config('app.url')); ?>webinars/accelerating-mrna-speaker-3.jpg" alt="Namrata Saxena" title="Namrata Saxena" class="img-fluid">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12 text-center">
                            <div class="card mb-3" style="cursor:pointer;height: calc(100% - 1rem);" data-toggle="modal" data-target="#speaker4">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="<?php echo e(config('app.url')); ?>webinars/accelerating-mrna-speaker-4.jpg" alt="Anastasia Darwitan" title="Anastasia Darwitan" class="img-fluid">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12 text-center">
                            <div class="card mb-3" style="cursor:pointer;height: calc(100% - 1rem);" data-toggle="modal" data-target="#speaker5">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="<?php echo e(config('app.url')); ?>webinars/accelerating-mrna-speaker-5.jpg" alt="Walter Feng" title="Walter Feng" class="img-fluid">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12 text-center">
                            <div class="card mb-3" style="cursor:pointer;height: calc(100% - 1rem);" data-toggle="modal" data-target="#speaker6">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="<?php echo e(config('app.url')); ?>webinars/accelerating-mrna-speaker-6.jpg" alt="Timothy Bolus" title="Timothy Bolus" class="img-fluid">
                ...
                <div id="myForm" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content BG-BLUE">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo e(route('acceleratingMrna.post')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                ...
                <div id="myModal" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-seconadry" role="button" id="aa" name="aa" href="<?php echo e(url('promotion/accelerating-mrna-research-and-manufacturing')); ?>" aria-expanded="false">
                                    Close
                                </a>
                            </div>
                        </div>
...
</html><?php /**PATH /home/pharmafocusasia/public_html/resources/views/flatpages/accelerating-mrna-research-and-manufacturing.blade.php ENDPATH**/ ?>