...
<head>
	...
	<title>World Courier - Success Factors for Commercial Temperature Controlled Shipments</title>

	<link rel="shortcut icon" href="<?php echo e(config('app.url')); ?>/images/favicon.ico" type="image/x-icon">

	<!-- Meta Tags -->
	<meta property="og:title" content="World Courier - Success Factors for Commercial Temperature Controlled Shipments" />
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/world-courier-ondemand/world-courier-og.jpg" />
	<link rel="canonical" href="<?php echo e(url('world-courier-ondemand-webinar')); ?>" />
	...
	<meta property="og:url" content="<?php echo e(url('world-courier-ondemand-webinar')); ?>" />
		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-8 col-12 my-auto offset-md-4 pt-1 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/world-courier-ondemand/world-courier-logo.png" alt="World Courier" class="ml-2 img-fluid">
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<div class="shadow bg-light video">
					<img type="btn" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/world-courier-ondemand/world-courier-banner.jpg" alt="World Courier Webinar" title="World Courier Webinar" class="img-fluid" />
				</div>
			</div>
			...
			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 person pt-3">
						<h1 class="font-weight-bold TXT-RED font-20">Success Factors & Best Practices for Commercial Temperature Controlled Shipments</h1>
						<p>This webinar will place an emphasis the critical successful factors in developing a GDP compliant Transportation Network. From understanding your responsibility as a contract giver, to discussing some of the critical factors that will successfully help you develop a compliant network.</p>
						<p>World Courier will also share our insights on how to assess the packaging solutions currently available in the market with practical advice on what to consider to manage risks in your transportation network.</p>
						<h2 class="font-20 TXT-BLUE font-weight-bold">Delivering innovation</h2>
						<p>At World Courier, we move innovation forward.  Whether designing and executing world-class logistics processes for the  biopharmaceutical  industry, or providing emergency logistical support for other key  industries, we’ve built our reputation on half a century of flawless  supply chain logistics execution.</p>
					</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3 mb-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/world-courier-ondemand/world-courier-video-thumb.jpg" alt="World Courier Webinar Video" title="World Courier Webinar Video" class="img-fluid video shadow border text-center" />
			</div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-4 mt-2 text-center">
				<div class="shadow BG-BLUE p-3">
					<h3 class="mb-0 text-white font-weight-bold font-20">" Professionals across the globe have already benefitted. Hurry register now! "</h3>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
				...
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-12 col-12 person text-center">
							<img src="<?php echo e(config('app.url')); ?>webinars/world-courier-ondemand/world-courier-stanley-soh.jpg" alt="Stanley Soh" title="Stanley Soh" class="img-fluid border mt-2" />
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-BLUE mt-2 mb-2"><strong>Stanley Soh</strong></h2>
							<p class="gray-text mb-2"><em>Senior Regional Manager Quality</em></p>

							<p class="mb-1">Stanley Soh is Senior Regional Quality Manager for Asia Pacific at World Courier. Stanley is responsible for ensuring the compliance of the countries in Asia Pacific to World Courier’s Quality Management System which includes both ISO9001 and Good Distribution Practice (GDP).</p>

							<p class="mb-1">Stanley has wide experience in the Transportation and Logistics Industry having previously worked in Singapore Airlines in several countries around the world and DHL in Singapore before joining World Courier in 2005. In 2009, he moved to his current position in Quality when the Quality Management System incorporating GDP was introduced.</p>

							<p class="mb-1">Stanley has an Honours Degree in Social Sciences from the National University of Singapore and a MBA specialising in Strategic Management from the Nanyang Technological University. He is also a certified Dangerous Goods Instructor and holds an advanced certificate in Training and Assessment.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 person mb-0">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-12 col-12 person text-center">
							<img src="<?php echo e(config('app.url')); ?>webinars/world-courier-ondemand/world-courier-kathy-goh.jpg" alt="Kathy Goh" title="Kathy Goh" class="img-fluid border mt-2" />
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-BLUE mt-2 mb-2"><strong>Kathy Goh</strong></h2>
							<p class="gray-text mb-2"><em>Product Manager, Commercial Supply Chain, APACr</em></p>
							<p class="mb-1">Kathy is APAC Product Manager for Commercial Supply Chain at World Courier, part of AmerisourceBergen’s global specialty logistics business. Kathy has 15 years of experience in the logistics industry, with roles as service provider, packaging vendor and user.</p>
							<p class="mb-1">Kathy holds a MSc in Supply Chain and Logistics Management from University of Warrick. She has a special interest in end to end supply chain visibility and temperature control risk management.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo e(route('worldCourierOndemandWebinar.post')); ?>" method="post">
							...
							<div class="row">
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
										...
										<input type="hidden" name="type" id="type" value="World Courier Ondemand Webinar" />
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a class="btn btn-primary" role="button" id="aa" name="aa" href="<?php echo e(url('world-courier-ondemand-webinar')); ?>" aria-expanded="false">
						Close
					</a>
				</div>
			</div>
...
</html><?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/worldcourierondemandwebinar/index.blade.php ENDPATH**/ ?>