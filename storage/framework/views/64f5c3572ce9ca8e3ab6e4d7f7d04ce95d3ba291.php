...
<head>
	...
	<title>Thermo Fisher Scientific Webinar - How can LIMS deliver value to your pharma manufacturing lab?</title>

	<link rel="shortcut icon" href="<?php echo e(config('app.url')); ?>/images/favicon.ico" type="image/x-icon">

	<!-- Meta Tags -->
	<meta property="og:title" content="Thermo Fisher Scientific Webinar - How can LIMS deliver value to your pharma manufacturing lab?" />
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/thermofisher-scientific/thermofisher-ondemand-og.jpg" />
	<link rel="canonical" href="<?php echo e(url('thermofisher-scientific-webinar')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('thermofisher-scientific-webinar')); ?>" />
...
<?php if(view()->exists('webinars.banner')): ?>
  ...
  <?php endif; ?>
		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-8 col-12 my-auto offset-md-4 pt-1 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/thermofisher-scientific/thermofisher-logo.png" alt="Thermo Fisher Scientific" class="ml-2 img-fluid">
				</p>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<div class="shadow bg-light">
					<img src="<?php echo e(config('app.url')); ?>webinars/thermofisher-scientific/thermofisher-ondemand-banner.jpg" alt="Thermo Fisher Scientific Webinar" title="Thermo Fisher Scientific Webinar" class="img-fluid" />
				</div>
			</div>
			...
			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
		      		...
		      		<div class="col-lg-12 col-md-12 col-sm-12 col-12 person pt-3">
		      			<h1 class="font-weight-bold TXT-RED font-20">How can LIMS deliver value to your Pharma Manufacturing Lab?</h1>
		      			<p>Please join our upcoming webinar focused on how laboratory information management system (LIMS) can deliver value and efficiency, and increase productivity, in your pharmaceutical manufacturing laboratory.  Thermo Fisher Scientific SampleManager LIMS software can provide a complete, scalable solution that meets all your laboratory needs.</p>

						<div class="pt-2 pb-4">
							<div class="p-2 PF-BrdrDDD mb-1 bg-light shadow" align="center">
								<h2 class="mb-1 pt-2 TXT-RED font-20"><strong>08th December 2020</strong> <span class="small text-secondary ml-3">(Tuesday)</span></h2>
								<!-- <p class="small mb-1 gray-text">(Tuesday)</p> -->
								<p class="mt-2 mb-2 font-weight-bold font-16">08:30 IST (India) | 10:00 WIB (West Indonesia) | 10:00 ICT (Thailand, Vietnam) | 11:00 SGP / MYT / PHL | 13:00 AEST (Australia) | 14:00 AEDT (Australia)</p>
							</div> 
						</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3 mb-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/thermofisher-scientific/thermofisher-video-thumb.jpg" alt="Thermo Fisher Webinar Video" title="Thermo Fisher Webinar Video" class="img-fluid video shadow border text-center" />
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
				<div class="row">
					<div class="col-lg-7 col-md-7 col-sm-12 col-12">
						<h2 class="font-weight-bold TXT-RED font-18">In this webinar, participants will learn about</h2>
						<ul style="list-style-type: disc;padding-left: 16px;">
							<li class="pb-2">The value of LIMS and how it can address industry challenges and trends</li>
							<li class="pb-2">Preconfigured industry-standard features available with our solution</li>
							<li class="pb-2">How SampleManager LIMS software drives compliance and data integrity</li>
						</ul>
					</div>

					<div class="col-lg-5 col-md-5 col-sm-12 col-12">
						<h2 class="font-weight-bold TXT-RED font-18">Who should attend:</h2>
						<ul style="list-style-type: disc;padding-left: 16px;">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-4 mt-2 text-center">
				<div class="shadow BG-BLUE p-3">
					<h3 class="mb-0 text-white font-weight-bold font-18">This webinar is to share how Thermo Fisher enables the digital transformation of its customers through digital solutions and success stories in pharmaceutical industry in Asia Pacific.</h3>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">	
	    <div class="row">
	    	<div class="col-md-12">
	    		<h3 class="PF-TXTRED font-weight-bold font-20 text-uppercase mb-3">Speakers:</h3>
	    	</div>
	    		...
	    		<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
	    			<div class="row">
	    				<div class="col-lg-2 col-md-2 col-sm-12 col-12 person text-center">
	    					<img src="<?php echo e(config('app.url')); ?>webinars/thermofisher-scientific/speaker-1.jpg" alt="Daren Cumberbatch" title="Daren Cumberbatch" class="img-fluid border mt-2" />
	    				</div>
	    				<div class="col-lg-10 col-md-10 col-sm-12 col-12">
	    					<h2 class="TXT-RED mt-2 mb-2"><strong>Mr Daren Cumberbatch</strong></h2>
	    					<p class="gray-text mb-2"><em>Sales Manager, Australia and New Zealand, Digital Science, Thermo Fisher Scientific</em></p>
	    					<p class="mb-1">Mr Daren Cumberbatch leads Thermo Fisher's Digital Science ANZ business. Digital Science provides market-leading laboratory and data management solutions. These solutions enable customers to advance science, increase efficiency, compliance and profitability. Daren joined Thermo Fisher in 2014 as a Chromatography Product Specialist, promoted to Principal Territory Manager, Chromatography and Informatics, and again in February 2018 as Sales Manager Digital Science. Previously, Daren worked for AstraZeneca UK in R&D for 13 years developing Oncology and CVGI formulations, using LIMS for 10 years (an “Expert-User”). Daren is a Chartered Chemist (MRSC), graduated in Chemistry from Leeds in 1991 and an MSc in Analytical Chemistry from Huddersfield in 1997.</p>
	    				</div> 
	    			</div>
	    		</div>
	    	</div>

	    	<div class="col-lg-12 col-md-12 col-sm-12 col-12 person mb-0">
	    		<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
	    			<div class="row">
	    				<div class="col-lg-2 col-md-2 col-sm-12 col-12 person text-center">
	    					<img src="<?php echo e(config('app.url')); ?>webinars/thermofisher-scientific/speaker-2.jpg" alt="June Tham" title="June Tham" class="img-fluid border mt-2" />
	    				</div>
	    				<div class="col-lg-10 col-md-10 col-sm-12 col-12">
	    					<h2 class="TXT-RED mt-2 mb-2"><strong>Ms June Tham</strong></h2>
	    					<p class="gray-text mb-2"><em>Sales Manager, South East Asia, Digital Science, Thermo Fisher Scientific</em></p>
	    					<p class="mb-1">Ms June Tham leads Thermo Fisher's Digital Science South East Asia business. Digital Science provides market-leading laboratory and data management solutions. These solutions enable customers to advance science, increase efficiency, compliance and profitability. June graduated from University of Birmingham (UK) with a BSc in Software Engineering and Computer Science. She has more than 25 years experience in the Informatics business sector and had more than 15 years experience in sales and support of Thermo Fisher Scientific SampleManager LIMS software in South East Asia countries.</p>
	    				</div> 
	    			</div>
	    		</div>
	    	</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo e(route('thermofisherscientificWebinar.post')); ?>" method="post" id='writemessage'>
							...
							<div class="row">
								<div class="col-md-12 mb-2">
									<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
										...
										<input type="hidden" name="type" id="type" value="Thermo Fisher Scientific Ondemand Webinar" />
										<input type="hidden" name="formtype"  value="modal-form" />
										<input type="hidden" name="callfrom"  value="<?php echo e(Request::segment(1)); ?>" />

										<input type="hidden" name="thank_message" value="Thank you for showing interest in <strong>Thermo Fisher Scientific Webinar</strong>. One of our concerned team will get back to you soon.">

										<input type="hidden" name="client_message" value="Thank You for showing interest in <strong>Thermo Fisher Scientific Webinar</strong>. Your visitor registration was successful and one of our concerned team would get back to you at the earliest.">
								...
								<div class="col-md-12 mb-2">
									<div class="form-group">
										<div class="custom-control custom-checkbox mb-1">
											...
											<label class="custom-control-label small" for="email_updates">I would like to receive email updates about Thermo Fisher Scientific products, services and events</label>
										</div>
										<div class="custom-control custom-checkbox mb-1">
										...
										<div class="custom-control custom-checkbox mb-1">
											...
											<label class="custom-control-label small" for="representative">I have more questions and would like to be contacted by a Thermo Fisher Scientific representative</label>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12 mb-2">
									<div class="form-group text-center mb-1">
										<button type="submit" value="submit" class="btn btn-danger pl-5 pr-5">SUBMIT</button>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="form-group mb-1">									
										<small class="mt-2 text-secondary">
											I understand and agree to Thermo Fisher Scientific <a href="https://www.thermofisher.com/us/en/home/global/privacy-policy.html" target="_blank" class="text-secondary">*Privacy Policy</a>
										</small>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('thermofisher-scientific-webinar')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/thermofisherscientific/index.blade.php ENDPATH**/ ?>