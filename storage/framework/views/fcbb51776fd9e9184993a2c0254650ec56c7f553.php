			...
			<div class="row">
				<div class="col-md-8 offset-md-2 mt-4">
					<video width="100%" controls autoplay>
						<source src="<?php echo e(config('app.url')); ?>webinars/suez-sievers/ondemand.mp4" type="video/mp4">
					</video>
				</div>
			</div> 
		</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/suez-sievers/videosuccess.blade.php ENDPATH**/ ?>