...
<head>
	...
	<title>Solutions for Laboratory Information Management </title>
	<!-- Meta Tags -->
	<meta name="description" content="Quality management has been seen as one of the most crucial part in biotech and pharmaceuticalindustry. As corporations take steps to improve quality and efficiency, laboratory information management system(LIMS) has been utilized to solve laboratory issues that QA/QC department faces." />
	<meta name="keywords" content="" />

	<meta property="og:title" content="Solutions for Laboratory Information Management" />
	<meta property="og:description" content="Quality management has been seen as one of the most crucial part in biotech and pharmaceuticalindustry. As corporations take steps to improve quality and efficiency, laboratory information management system(LIMS) has been utilized to solve laboratory issues that QA/QC department faces." />
	<meta property="og:Keywords" content="" />

	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/yokogawa-2021/yokogawa-og-image.jpg" />

	<link rel="canonical" href="<?php echo e(url('yokogawa-webinar2021')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('yokogawa-webinar2021')); ?>" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/yokogawa-2021/yokogawa-webinar-logo.jpg" alt="Yokogawa webinar-logo" class="ml-2 img-fluid" />
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/yokogawa-2021/Yokogawa-banner.jpg" alt="Yokogawa webinar" title="Yokogawa webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">Solutions for Laboratory Information Management </h2>

						<p class="font-weight-bold">Quality management has been seen as one of the most crucial part in biotech and pharmaceuticalindustry. As corporations take steps to improve quality and efficiency, laboratory information management system(LIMS) has been utilized to solve laboratory issues that QA/QC department faces. This talk will focus on how this digitalized system, LIMS, help users standardize quality inspection procedures, manage data, reduce human error, integrate with other system and comply with regulations. Also, this talk will give introduction on how to select the perfect LIMS based on different types and functionality of laboratory. </p>
					</div>
				</div> 
			</div>
			
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/yokogawa-2021/yokogawa-video-image.jpg" alt="Yokogawa webinar" title="Yokogawa webinar" class="img-fluid video shadow border text-center" />
				<div class="p-2 PF-BrdrDDD mb-1 bg-light shadow mt-4" align="center">
					<h3 class="pt-1 pb-1">
						<strong class="TXT-RED font-20">12<sup>th</sup> July 2021</strong>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/yokogawa-2021/ckshiau-speaker.jpg" alt="Chang-keng Shiau" title="Chang-keng Shiau" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Chang-keng Shiau </strong></h2>
							<p class="gray-text mb-2"><em>Engineering Consultant, Taiwan </em></p>
							<p class="mb-1">Chang-keng Shiau is an engineer with years of experience in LIMS, including software testing, response to customer requirement and market analysis. He majored in chemical engineering and has a sound knowledge in manufacturing process and digitalized solutions. </p>
						</div> 
					</div>
				</div>
			</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo e(route('yokogawawebinar2021.post')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12 mb-2">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									...
									<input type="hidden" name="type" id="type" value="On-demand Yokogawa Webinar 2021">
                    									
									<input type="hidden" name="formtype" value="modal-form">
									
									<input type="hidden" name="thank_message" value="Your On-demand Yokogawa Webinar 2021 registration was successfully completed.">
									
									<input type="hidden" name="client_message" value="Thank you for showing your interest in Yokogawa Webinar 2021">
							...
							<div class="col-md-12 mb-2">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="email_updates">I would like to receive email updates about yokogawa-webinar products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="representative">I have more questions and would like to be contacted by a yokogawa-webinar representative</label>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('yokogawa-webinar')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/yokogawawebinar2021/index.blade.php ENDPATH**/ ?>