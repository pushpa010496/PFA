          ...
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
                ...
                <a href="<?php echo e(url('magazine')); ?>"><?php echo e(trans('messages.archives-magazine_title')); ?> </a>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="PF-BrdrBEEE col-lg-12 col-md-12 col-sm-12 col-12 p-0 mb-3">
                  ...
                  <h1 class="PF-Bshelf pt-2"><?php echo e(trans('messages.archives-magazine_title')); ?></h1>            

                </div>

                  <p><?php echo e(trans('messages.archives-magazine_text')); ?></p>
                      ...
                      <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        ...
                        <div class="row">  
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-8 col-12">
                            ...
                            <li class="ml-3"><a href="#<?php echo e(Str::slug($category->name)); ?>"><?php echo e($category->name); ?></a></li>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 title-list">
                ...
                <?php $__currentLoopData = $ebook->issue->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                         
                 ...
                 <div class="pt-4">
                  ...
                  <h2 class="PF-Caps PF-TXTRED" id="<?php echo e(Str::slug($category->name)); ?>">
                  ...
                  <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($article->category_id ==  $category->id): ?>
                      ...
                      <p class="PF-TXTBlk"><?php echo e(\Illuminate\Support\Str::limit(preg_replace('/[^a-zA-Z\s]/', '', strip_tags(html_entity_decode(ucfirst($article->short_description)))),$limit = 350, $end = '...')); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pharmafocusasia/public_html/resources/views/magazine/ebook/archive_magazine.blade.php ENDPATH**/ ?>