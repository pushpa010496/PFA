...
<head>
	...
	<meta property="og:title" content="UV-Vis measurement using SoloVPE速 slope spectroscopy | Solovpe Webinar" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="<?php echo e(config('app.url')); ?>webinars/repligen-korean/on-demand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/repligen-webinar-korean/videosuccess.blade.php ENDPATH**/ ?>