...
<head>
	...
	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/iktos/iktos-og-image.jpg" />

	<link rel="canonical" href="<?php echo e(url('iktos-ai-webinar')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('iktos-ai-webinar')); ?>" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/iktos/iktos-logo.jpg" alt="Iktos-webinar-logo" class="ml-2 img-fluid" />
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/iktos/iktos-banner.jpg" alt="Iktos-Webinar" title="Iktos-Webinar" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/iktos/iktos-ondemand-video-image.jpg" alt="Iktos Webinar" title="Iktos Webinar" class="img-fluid video shadow border text-center" />
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/iktos/Sree-image.jpg" alt="Dr. Sree Vadlamudi" title="Dr. Sree Vadlamudi" class="img-fluid">
						</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo e(route('iktosaiwebinar.post')); ?>" method="post" id='writemessage' >
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('iktos-webinar')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/iktosai-webinar/index.blade.php ENDPATH**/ ?>