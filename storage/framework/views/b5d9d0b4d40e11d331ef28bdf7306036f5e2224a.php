...
<head>
	...
	<title>How LIMS can optimize your time & data, The future of Digital Labs using Lab Informatics Platforms</title>
	<!-- Meta Tags -->
	<meta name="description" content="Lab managers are the most impacted by lab information management activities, especially in areas where compliance plays a special role. A good LIMS can make this efficient to manage." />
	<meta name="keywords" content="" />

	<meta property="og:title" content="How LIMS can optimize your time & data, The future of Digital Labs using Lab Informatics Platforms" />
	<meta property="og:description" content="Lab managers are the most impacted by lab information management activities, especially in areas where compliance plays a special role. A good LIMS can make this efficient to manage." />
	<meta property="og:Keywords" content="" />

	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/caliber/caliber-og-image.jpg" />

	<link rel="canonical" href="<?php echo e(url('https://www.pharmafocusasia.com/caliber-technologies-webinar')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('https://www.pharmafocusasia.com/caliber-technologies-webinar')); ?>" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/caliber/caliber-logo.png" alt="Caliber-webinar logo" class="ml-2 img-fluid"> 
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/caliber/Caliber-Banner.jpg" alt="Caliber-Webinar" title="Caliber-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">How LIMS can optimize your time & data, The future of Digital Labs using Lab Informatics Platforms.</h2>

						<p>Lab managers are the most impacted by lab information management activities, especially in areas where compliance plays a special role. A good LIMS can make this efficient to manage. In this webinar Mr. Rajasekhar, LIMS SME, will discuss about

<br>Understanding current trends in lab digitalization and achieve online audit ready lab
<br>Improving productivity, compliance, and integrity with LIMS
<br>Redefining your lab, beyond compliance to achieve a tomorrow-ready lab</p>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/caliber/Caliber-video-image.jpg" alt="Caliber Webinar" title="Caliber Webinar" class="img-fluid video shadow border text-center" />
				<div class="p-2 PF-BrdrDDD mb-1 bg-light shadow mt-4" align="center">
					<h3 class="pt-1 pb-1">
						<strong class="TXT-RED font-20">12th July 2021</strong>
						<span class="small text-secondary ml-2 mr-3">(Monday)</span>
						<p class="mt-2 mb-0 font-weight-bold font-16">2.00 PM (IST) - 03.00 PM (IST)</p>
					</h3>						
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/caliber/rajasekhar.png" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Rajasekhar G</strong></h2>
							<p class="gray-text mb-2"><em>Head, Global Delivery Management, India</em></p>
							<p class="mb-1">Rajasekhar has 18 years of extensive work exposure to various functions at world class companies in pharma, petroleum, refining, and life sciences domain. He is well experienced with the quality control procedures and processes of these companies. Global Delivery Head – GDM for all Caliber Products relating to Quality Control (LIMS), Quality Assurance (QAMS, DMS & N5CMS) and Manufacturing (eLog, IPQC and eBRM). He is in charge of the Business Process Analysis and harmonization of the implementation process across all products. As Product Owner for CaliberLIMS he is responsible for

<br>Prioritization of user stories and
<br>Product Version Management and Release of this product
<br>His interests include team building through fun-based activities like acting and sports.</p>
						</div> 
					</div>
				</div>
			</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo e(route('calibertechnologieswebinar.post')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12 mb-2">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									...
									<input type="hidden" name="type" id="type" value="On-demand Caliber Technologies Webinar ">
                    									
                                    <input type="hidden" name="formtype" value="modal-form">
                                    
                                    <input type="hidden" name="thank_message" value="Your On-demand Caliber Technologies Webinar  registration was successfully completed.">
                                    
                                    <input type="hidden" name="client_message" value="Thank you for showing your interest in Caliber Technologies Webinar ">
							...
							<div class="col-md-12 mb-2">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="email_updates">I would like to receive email updates about Caliber-webinar products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="representative">I have more questions and would like to be contacted by a Caliber-webinar representative</label>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('https://www.pharmafocusasia.com/caliber-technologies-webinar')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/calibertechnologies-webinar/index.blade.php ENDPATH**/ ?>