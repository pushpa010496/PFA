...
<head>
	...
	<title>Obviohealth Webinar - Virtual: A game changer Lessons from the trenches of 30+ decentralized trials.</title>
	<!-- Meta Tags -->
	<meta name="description" content="" />
	<meta name="keywords" content="" />

	<meta property="og:title" content="Obviohealth Webinar" />
	<meta property="og:description" content="" />
	<meta property="og:Keywords" content="" />

	<meta property="og:image" content="<?php echo e(config('app.url')); ?>webinars/obviohealth/obviohealth-webinar-banner.jpg" />

	<link rel="canonical" href="<?php echo e(url('obviohealth-webinar')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('obviohealth-webinar')); ?>" />
	...
	<style type="text/css">
		...
		.font-20{font-size: 22px;line-height: 1.4;}
	</style>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/obviohealth/obviohealth-webinar-logo.png" alt="obviohealth-webinar-logo" class="ml-2 img-fluid"> 
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/obviohealth/obviohealth-webinar-banner.jpg" alt="obviohealth Webinar" title="obviohealth-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20 pb-2">Virtual: A game changer<br>Lessons from the trenches of 30+ decentralized trials. </h2>
						<p>ObvioHealth, a pioneering VRO (Virtual Research Organization) will share case studies and insider insights based on more than 30 fully virtual or hybrid studies conducted across 20 countries and 13 therapeutic areas. This webinar will answer questions like: How do you determine whether a trial can go virtual? What data collection methods are best adapted to a decentralized trial? Can virtual assistants really improve compliance? A step-by-step virtual trial playbook for sponsors wishing to embark on a DCT journey.</p>
					</div>	
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3 mb-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/obviohealth/obviohealth-webinar-video-thumb.jpg" alt="Obvio Health" title="Obvio Health" class="img-fluid video shadow border text-center" />


				<div class="pt-5"> 
					<div class="p-2 PF-BrdrDDD mb-1 bg-light shadow" align="center">
						<h2 class="mb-1 pt-2 TXT-RED font-20"><strong>11th February 2021</strong> <span class="small text-secondary ml-3">(Thursday)</span></h2>
						<!-- <p class="small mb-1 gray-text">(Tuesday)</p> -->
						<p class="mt-2 mb-2 font-weight-bold font-16">10:00 AM (IST) | 12:30 PM (SGT) | 3:30 PM (AEDT)</p>
					</div>
				</div>
			</div>
		...
		<div id="videoFormModal" class="modal fade" role="dialog">
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<form action="<?php echo e(route('obviohealthwebinar.post')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12 mb-2">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									...
									<input type="hidden" name="type" id="type" value="obviohealth-webinar" />
									<input type="hidden" name="formtype"  value="modal-form" />
									<!-- <input type="hidden" name="thank_message" value="Thank You for showing interest in ObvioHealth webinar. One of our concerned team will get back to you soon."> -->

									<!-- <input type="hidden" name="client_message" value="Thank You for showing interest in ObvioHealth webinar. Your registration was successful and one of our concerned team would get back to you at the earliest."> -->
							...
							<div class="col-md-12 mb-2">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="email_updates">I would like to receive email updates about obviohealth products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="representative">I have more questions and would like to be contacted by a obviohealth representative</label>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="<?php echo e(url('obviohealth-webinar')); ?>" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
...
<?php /**PATH /home/pharmafocusasia/public_html/resources/views/webinars/obvio-health-webinar/index.blade.php ENDPATH**/ ?>