        ...
        <div class="row PF-WytBG">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <iframe id="form-iframe" src="{{ config('app.url').'e-newsletters/'.$data->file }}" style="margin:0; width:100%; height:2050px; border:none; overflow:hidden;" scrolling="no"></iframe>
              </div>
