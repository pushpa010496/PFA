			...
			<div class="container" align="center">
				...
				<div class="col-12 magz-bg pb-1">
					...
					<h3 class="font-21 pb-0 pt-2 font-weight-bold">
						...
						<a href="{{url('archives')}}" target="_blank" class="text-white">Our Magazines</a>
					...
					<div class="mt-5"> 
						...
						@foreach($issues as $val)
							...
							<a href="{{ url('archives-magazine').'/'.$val->issue_id }}" target="_blank">

								<img class=" img-fluid hover-img" src="{{ config('app.url').'ebooks/'. Str::slug($val->issue->issue_no).'/'.$val->magazine_image }}" alt="{{$val->issue->issue_no}}" width="175" height="223"  />
						...
						<h2 class="text-right mt-0">
							...
							<a href="{{url('archives')}}" target="_blank" class="text-white">Our Previous Issues 
		       	...
		       	<div class="col-12 pt-4">
		       		...
		       		<div class="row">
		       			...
		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4" align="center">
		       				...
		       				<img src="{{config('app.url')}}/advertisers/tsi-logo.png" alt="TSI" class="img-fluid" width="50%" />

		       			</div>

		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4" align="center">

		       				<img src="{{config('app.url')}}/advertisers/pall-corporation-logo.png" alt="pall" class="img-fluid" width="50%" />

		       			</div>

		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4" align="center">

		       				<img src="{{config('app.url')}}/advertisers/abbott.png" alt="abbott" class="img-fluid" width="50%" />

		       			</div>

		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4" align="center">

		       				<img src="{{config('app.url')}}/advertisers/emirates-skycargo-logo.png" alt="abemirates-skycargo" class="img-fluid" width="50%" />

		       			</div>

		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4" align="center">

		       				<img src="{{config('app.url')}}/advertisers/vetter-logo.png" alt="vetter" class="img-fluid" width="50%" />

		       			</div>

		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4" align="center">

		       				<img src="{{config('app.url')}}/advertisers/etihad-logo.png" alt="etihad" class="img-fluid" />

		       			</div>

		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2" align="center">

		       				<img src="{{config('app.url')}}/advertisers/meco-logo.png" alt="meco" class="img-fluid" />

		       			</div>

		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2" align="center">

		       				<img src="{{config('app.url')}}/advertisers/perkinelmer-logo.png" alt="perkinelmer" class="img-fluid pl-4 pr-4" />
		       			...
		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2" align="center">
		       				...
		       				<img src="{{config('app.url')}}/advertisers/lufthansa-cargo.png" alt="lufthansa" class="img-fluid pl-4 pr-4" />

		       			</div>

		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2" align="center">

		       				<img src="{{config('app.url')}}/advertisers/turkish-cargo-logo.png" alt="turkish-cargo" class="img-fluid" />

		       			</div>

		       			<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-2" align="center">

		       				<img src="{{config('app.url')}}/advertisers/chemspeed-logo.png" alt="chemspeed" class="img-fluid" />
