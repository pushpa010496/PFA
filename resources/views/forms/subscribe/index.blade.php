	...
	<div class="border mt-4 mb-4 p-4">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-12 ebook">	
				...
				<img src="{{config('app.url')}}images/latest-issue-devices-banner.jpg" alt="Digital Version" class="img-fluid">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-12 mag">
				...
				<img src="{{config('app.url')}}images/4-magazine.png" alt="Print Version" class="img-fluid">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-seconadry" role="button"   id="aa" name="aa" href="{{ url('/subscribe') }}" aria-expanded="false">
