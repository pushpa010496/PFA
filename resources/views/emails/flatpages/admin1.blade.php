      ...
      <table width="500" border="0" cellpadding="5">
        ...
        @if(@$first_name !='')
          ...
          <tr>
            ...
            <tr>
            <td width="20">&nbsp;</td>
            <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Do you have a Project?</td>
            <td width="30" align="left" valign="middle"><strong>:</strong></td>
         ...
         @if(@$state != '') 
            ...
            <tr>
            <td width="20">&nbsp;</td>
            <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Addressing-Bioprocessing-Scale-Up-Challenges</td>
            <td width="30" align="left" valign="middle"><strong>:</strong></td>
        ...
        @if(@$current_project != '')
            ...
            @endif
                ...
                @if(@$email_updates != '')  
                  <tr>
                    <td width="20">&nbsp;</td>
                    <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Solutions-for-vaccine-development</td>
                    <td width="30" align="left" valign="middle"><strong>:</strong></td>
                  ...
                  <tr>
                    <td width="20">&nbsp;</td>
                    <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Upstream-Bioprocessing-Improving-efficiency-through-digital-tools</td>
                    <td width="30" align="left" valign="middle"><strong>:</strong></td>
                  ...
                  <tr>
                    <td width="20">&nbsp;</td>
                    <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Increasing-the-Reproducibility-of-Cell-Culture-Bioprocesses</td>
                    <td width="30" align="left" valign="middle"><strong>:</strong></td>
