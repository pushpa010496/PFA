      ...
      <table width="800" border="0" cellpadding="5">
          ...
          <tr>
           ...
           @if(@$pdf1 != '')
                ...
                <a href="{{ $pdf1 }}">label-free-biosensor-analysis-applications-guide Download Link</a>
                     
            @endif
            <br>
            @if(@$pdf2 != '')
       
       <a href="{{ $pdf2 }}">systems-superior-performance-unrivaled-flexibility Download Link</a>
