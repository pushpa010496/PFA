...
<body>
        ...
        <form id="elqForm" action="{{ route('PharmaSoftwareAssessment.post')}}" method="post" target="postFrame">
        @csrf
                ...
                <table cellspacing="0" cellpadding="0" border="0" class="table">
                    <tr>
                        ...
                        <td id="progress16" data-panel="question16" class="inactive">
                            ...
                            <img src="{{config('app.url')}}zebra/img/progress1-16.png" class="inactive">
                        </td>
                    ...
                    <td id="progress17" data-panel="question17" class="inactive" data-disabled="true">
                            <img src="{{config('app.url')}}zebra/img/progress-17-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress1-17.png" class="inactive">
                        </td>
                        <td id="progress18" data-panel="question18" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-18-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-18.png" class="inactive">
                        </td>
                        <td id="progress19" data-panel="question19" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-19-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-19.png" class="inactive">
                        </td>
                        <td id="progress20" data-panel="question20" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-20-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-20.png" class="inactive">
                        </td>
                        <td id="progress21" data-panel="question21" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-21-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-21.png" class="inactive">
                        </td>
                        <td id="progress22" data-panel="question22" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-22-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-22.png" class="inactive">
                        </td>
                        <td id="progress23" data-panel="question23" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-23-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-23.png" class="inactive">
                        </td>
                        <td id="progress24" data-panel="question24" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-24-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-24.png" class="inactive">
                        </td>

                        <td id="progress25" data-panel="question25" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-25-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-25.png" class="inactive">
                        </td>
                        <td id="progress26" data-panel="question26" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-26-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-26.png" class="inactive">
                        </td>
                        <td id="progress27" data-panel="question27" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-27-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-27.png" class="inactive">
                        </td>
                        <td id="progress28" data-panel="question28" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-28-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-28.png" class="inactive">
                        </td>
                        <td id="progress29" data-panel="question29" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-29-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-29.png" class="inactive">
                        </td>
                        <td id="progress30" data-panel="question30" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-30-active.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-30.png" class="inactive">
                        </td>
                        <td id="progress31" data-panel="question31" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-31-active1.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-31.png" class="inactive">
                        </td>
                        <td id="progress32" data-panel="question32" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-32-active1.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-32.png" class="inactive">
                        </td>
                        <!-- <td id="progress33" data-panel="question33" class="inactive">
                            <img src="{{config('app.url')}}zebra/img/progress-33-active1.png" class="active">
                            <img src="{{config('app.url')}}zebra/img/progress-33.png" class="inactive">
                        </td> -->
                    </tr>
                    <tr>
                    <td id="progress33" data-panel="question33" class="inactive">
