    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay id="myVideo">
              <source src="{{config('app.url')}}webinars/world-courier-ondemand/world-courier-success-factors.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>{{"Thank you for your interest. One of the representative from World Courier will get in touch with you soon."}}</p>
					<br>
					Thank You
					<br>
