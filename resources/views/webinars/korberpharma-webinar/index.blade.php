...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/korber/korber-og-img.jpg" />

	<link rel="canonical" href="{{url('korber-pharma-webinar')}}"/>
...
f
	...
	<meta property="og:url" content="{{url('korber-pharma-webinar')}}" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}webinars/korber/koerber_logo.jpg" alt="yokogawa-webinar-logo" class="ml-2 img-fluid" />
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/korber/korbar-banner.jpg" alt="Yokogawa-Webinar" title="Yokogawa-Webinar" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/korber/korbar-ondemand-video-image.jpg" alt="Korber Webinar" title="Korber Webinar" class="img-fluid video shadow border text-center" />
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="{{config('app.url')}}webinars/korber/JoshiManoj.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-12 col-12 person text-center">
							<h3 class="PF-TXTRED font-weight-bold font-18 text-uppercase mt-1">Speaker:</h3>
						<img src="{{config('app.url')}}webinars/korber/orchun-thakral.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="{{ route('korberpharmawebinar.post') }}" method="post" id='writemessage' >
						{{ csrf_field() }}
						<div class="row">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="{{url('korber-webinar')}}" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
