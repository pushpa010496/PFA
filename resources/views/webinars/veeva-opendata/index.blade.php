...
<head>
	...
	<title>Veeva OpenData Singapore Launch Webinar | Veeva Systems</title>

	<link rel="shortcut icon" href="{{ config('app.url') }}/images/favicon.ico" type="image/x-icon">

	<!-- Meta Tags -->
	<meta property="og:title" content="Veeva OpenData Singapore Launch Webinar" />
	...
	<meta property="og:image" content="{{config('app.url')}}images/veeva-opendata-ondemand-banner.jpg" />
	<link rel="canonical" href="{{url('veeva-opendata-ondemand-webinar')}}" />
	...
	<meta property="og:url" content="{{url('veeva-opendata-ondemand-webinar')}}" />
...
180deg
, rgba(50,139,215,1) 0%, rgba(11,61,103,1) 81%);
...
<body>
		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-8 col-12 my-auto offset-md-4 pt-1 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}images/veeva-logo.png" alt="World Courier" class="ml-2 img-fluid" width="150">
				</p>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<div class="shadow bg-light">
					<img type="btn" src="{{config('app.url')}}images/veeva-opendata-ondemand-banner.jpg" alt="World Courier Webinar" title="World Courier Webinar" class="img-fluid" />
				</div>
			</div>
			...
			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 person pt-3">
						<h1 class="font-weight-bold TXT-RED font-20">Veeva OpenData</h1>
						<p class="font-16">
						...
						<br>
						on 5 May 2021, we announced that Veeva OpenData launched in Singapore,
                        CASSANDRA BARKER ,Senior Director of  OpenData APAC held a webinar and shared what this means for organisations in singapore.

						</p>
						<h2 class="font-20 TXT-BLUE font-weight-bold">Topics to be discussed: </h2>
						<ul class="pl-4">
							<li class="font-16">The cost of bad data </li>
							<li class="font-16">The four foundations of a data-driven company</li>
							<li class="font-16">What good customer reference data looks like for your organisation - includes live demo</li>
							<li class="font-16">How to identify your company's level of data maturity</li>
						</ul>
		            ...
		            <div class="col-lg-12 col-md-12 col-sm-12 col-12 person pt-3">
						<ul class="pl-4">
						<li class="font-16">We are pleased to share that the webinar replay is now available to watch in your own time.</li>
						<li class="font-16">You are just one click away from learning how you can get accurate singapore HCP data at your fingertips </li>
						</ul>
					</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3 mb-3">
					...
					<form action="{{route('veevaOpendataOndemandWebinar.post')}}" method="post">
	               		@csrf
	               		<input type="hidden" name="formtype" value="normal-form">
	
	               		<input type="hidden" name="type" value="Veeva OpenData on demand webinar">	
	                  		
	                  		
	                  	<input type="hidden" name="site_name" value="PharmaFocusAsia">

	                  	<input type="hidden" name="thank_message" value="Thank you for registering your interest to access the on-demand webinar for The Veeva OpenData Singapore Launchs.As the on-demand webinar is only available for employees of pharmaceutical companies, you will receive a link once your registration has been approved">
						
						  <input type="hidden" name="client_message" value="Thank you for registering your interest to access the on-demand webinar for The Veeva OpenData Singapore Launchs.As the on-demand webinar is only available for employees of pharmaceutical companies, you will receive a link once your registration has been approved">
	                  ...
	                  <!-- 	<div class="form-group ">
	                  	...
	                  	<div class="form-group mb-1" align="left">
	                  		<p class="font-11 text-light mb-0">**on-demand webinar is only available for employees of  pharmaceutical companies.</p>
	                  	</div>
                	</form>  
				...
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-12 col-12 person text-center">
							<img src="{{config('app.url')}}images/veeva-opendata-ondemand-speaker.jpg" alt="CASSANDRA" title="CASSANDRA" class="img-fluid border mt-2" />
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-BLUE mt-2 mb-2"><strong>CASSANDRA BARKER</strong></h2>
							<p class="gray-text mb-2"><em>SENIOR DIRECTOR, OPENDATA APAC</em></p>

							<p class="mb-1 font-16">As Senior Director, OpenData APAC, Cassandra is responsible for the strategy and direction of OpenData in the region.</p>
							<p class="mb-1 font-16">Cassandra brings over 20 years of experience in business technology across both government and private sectors. Her proven business and marketing experience has helped organisations drive growth and change through data and technology enablement, product development and professional services engagements to a combination of ASX, government and international clients.</p>
						</div>
					</div>
				</div>
			</div>
   ...
   <div class="container">
   	<div class="row">
   		<div class="col-md-6 col-sm-12 col-12 offset-md-3 person pt-3">
	<h1 class="font-weight-bold text-white font-20 text-center BG-BLUE p-2">Register for access to the on-demand webinar now!</h1>
	</div>
   	</div>
   </div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a class="btn btn-primary" role="button" id="aa" name="aa" href="{{url('veeva-opendata-ondemand-webinar')}}" aria-expanded="false">
						Close
					</a>
				</div>
			</div>
