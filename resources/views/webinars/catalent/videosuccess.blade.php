...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/catalent/catalent-og-banner.jpg" />
	<link rel="canonical" href="{{url('catalent-webinar-success')}}"/>
	...
	<meta property="og:url" content="{{url('catalent-webinar-success')}}" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/catalent/catalent-video.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
