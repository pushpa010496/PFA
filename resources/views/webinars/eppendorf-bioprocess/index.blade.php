...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/eppendorf-bioprocess/eppendorf-og-ondemand.jpg" />

	<link rel="canonical" href="{{url('eppendorf-bioprocess-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('eppendorf-bioprocess-webinar')}}" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}webinars/eppendorf-bioprocess/eppendorf-logo.png" alt="Eppendorf" class="ml-2 img-fluid">
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/eppendorf-bioprocess/eppendorf-banner-ondemand.jpg" alt="Eppendorf" title="Eppendorf" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-7 col-md-7 col-sm-12 col-12 person pt-3">
      		...
      		<div class="col-lg-5 col-md-5 col-sm-12 col-12 person pt-3">
      			<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/eppendorf-bioprocess/eppendorf-video-thumb.jpg" alt="Eppendorf Webinar Video" title="Eppendorf Webinar Video" class="img-fluid video shadow border text-center" />		
      			...
      			<div class="row">
	      			<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-4">
	      				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow" align="center">
	      					...
	      					<img src="{{config('app.url')}}webinars/eppendorf-bioprocess/joerg-schwinde.jpg" alt="Joerg Schwinde" title="Joerg Schwinde" class="img-fluid rounded-circle border" width="100" />	      					
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="{{ url('eppendorf-bioprocess-webinar-success') }}" method="post" id='writemessage' >
							{{ csrf_field() }}
							<div class="row">
