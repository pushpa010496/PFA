...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/sartorius-car-t-ondemand-og.jpg" />

	<link rel="canonical" href="{{url('sartorius-car-t-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('sartorius-car-t-webinar')}}" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="https://industry.pharmafocusasia.com/webinars/sartorius-car-t-webinar/on-demand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
