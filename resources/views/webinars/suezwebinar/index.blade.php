		...
		<div class="row">
			<div class="col-lg-10 col-md-10 col-sm-12 col-12 offset-lg-1 offset-md-1 border bg-light pt-4">
				<div class="text-center">
					<img src="{{config('app.url')}}webinars/suezwebinar/webinar-toc-banner.jpg" alt="suez" title="suez" class="img-fluid shadow" />
				</div>
	...
	<div id="videoFormModal" class="modal fade" role="dialog">
		<div class="modal-dialog ">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{ url('suez-webinar-success') }}" method="post" id='writemessage' >
							{{ csrf_field() }}					
							<div class="row">
								<div class="col-md-6">
