...
<head>
	...
	<title>Oliver Healthcare Packaging</title>

	<link rel="shortcut icon" href="{{ config('app.url') }}/images/favicon.ico" type="image/x-icon">

	<!-- Meta Tags -->
	<meta property="og:title" content="Oliver Healthcare Packaging" />
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/oliver/oliver-healthcare-ondemand-banner.jpg" />
	<link rel="canonical" href="{{url('oliver-healthcare-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('oliver-healthcare-webinar')}}" />
...
<body> 
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/oliver/oliver-healthcare-ondemand-banner.jpg" alt="Oliver Healthcare" title="Oliver Healthcare" class="img-fluid shadow" />
			</div>
      		...
      		<div class="col-lg-7 col-md-7 col-sm-12 col-12 person pt-3">
				...
				<h2 class="font-weight-bold PF-TXTRED font-18">The relationship between packaging adhesives and particulate generation in nested syringe tubs.</h2>              			               		

      			<p class="mb-1">Did you know that particulate undetectable to the human eye can impact a drug’s solubility, stability and efficacy? Studies have linked presence of particles in pre-filled syringes to immune responses in patients.</p>
      			<p>The sterility of a drug delivery system is extremely important for pharmaceutical companies and manufacturers. Choosing the appropriate sterile barrier material that can help minimize particulate generation is a crucial decision that manufacturers must make to ensure the highest level of protection for their drug application. Especially considering the long process which includes drug development, product launch, and choosing a partner for syringe filling & packaging.</p>
            </div> 

			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-4 mb-4">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/oliver/oliver-healthcare-video-thumb.jpg" alt="Oliver Webinar" title="Oliver Webinar" class="img-fluid video shadow text-center border" />
			</div>


			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
				<h2 class="mb-2">
					<span class="font-14">Wednesday</span>, <span class="font-20 font-weight-bold PF-TXTRED ml-2">3<sup>rd</sup> June 2020</span>, <span class="mb-1 mt-1 ml-2 font-16">11am (GMT+8)</span>
				</h2>				
			</div>

			<div class="col-lg-3 col-md-3 col-sm-12 col-12 person pt-2">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow" align="center">
					...
					<img src="{{config('app.url')}}webinars/oliver/santosh-madival-speaker.jpg" alt="Santosh Madival" title="Santosh Madival" class="img-fluid rounded-circle pt-2" />
					<div class="pt-2">
						<p class="person-name PF-TXTRED mb-1">Santosh Madival</p>
						<p class="gray-text mb-1"><em>Senior Principal Engineer</em></p>
						<p class="mb-2 small">Technical Services, APAC</p>
					</div>                   
				</div> 

				<!-- <div class="col-md-12 pt-3 pb-3 text-center">
					<a href="https://add.eventable.com/events/5d0486d9da647d007d0101e4/5e9b153995878e059d130e75/" data-event="5e9b153995878e059d130e75" class="eventable-link" target="_blank" data-key="5d0486d9da647d007d0101e4" data-style="1">Add to Calendar</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://plugins.eventable.com/eventable.js";fjs.parentNode.insertBefore(js, fjs);}}(document, "script", "eventable-script");</script>
				</div>  -->         
			</div>

			<div class="col-lg-5 col-md-5 col-sm-12 col-12 person pt-2">
  				...
  				<ul style="list-style-type: disc; padding-left: 20px; line-height: 1.3;">
  					<li class="mb-2">How to significantly minimize particulate generation as a result of packaging adhesive technology.</li>
  					<li class="mb-2">How to meet the industry’s stringent regulatory requirements.</li>
  					<li class="mb-2">Different types of adhesive technologies.</li>
  					<li>How selecting the right adhesive for your application can help achieve lower particulate levels in prefillable syringe packaging.</li>
  				</ul>
  			</div>

			<div class="col-lg-4 col-md-4 col-sm-12 col-12 person pt-2">
				...
				<ul style="margin-left: -20px;">
					...
					<li>Manufacturers of IVD products</li>
					<li>Manufacturers of Pharmaceuticals</li>
	...
	<div class="container">	
		...
		<div class="row">
			<div class="col-md-12">
			  <h2 class="PF-TXTRED mt-2"><strong>About - Santosh Madival</strong></h2>
			  <p class="mb-1">Santosh is a Senior Principal Engineer at Oliver Healthcare Packaging, Singapore and is responsible for technical services support for customers within the Asia-Pacific region. He has over 18 years of experience in packaging development, quality assurance, packaging engineering, new packaging development and technical service. Santosh worked at Edwards Lifesciences and Zimmer Biomet as a packaging engineer, focused on higher-end class III device applications. A portion of his career was also in flexible film development, converting and lamination.</p>
			  <p class="mb-1">Santosh graduated from Michigan State University, with a Masters in Packaging Science, as well as a Bachelors degree in Chemistry and a Diploma in Packaging Technology from Mumbai University.</p>
			  <p class="mb-1">Santosh is a trained auditor for ISO13485.</p>
			</div>
		</div>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{ url('oliver-healthcare-webinar-success') }}" method="post" id='writemessage' >
						{{ csrf_field() }}	
						<div class="row">
							<div class="col-md-12">
								<div class="form-group {{ $errors->first('name', 'has-error')}}">
									<input class="form-control" id="name" name="name" placeholder="Full Name *" required=""  value="{{ old('name') }}"  type="text">	
									<input type="hidden" name="type" id="type" value="oliver-healthcare-webinar-video" />
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label small" for="email_updates">I would like to receive email updates about Oliver Healthcare Webinar products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label small" for="representative">I have more questions and would like to be contacted by a Oliver Healthcare Webinar representative</label>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="{{url('oliver-healthcare-webinar')}}" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
