...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/oliver/oliver-healthcare-og-img.jpg" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/oliver/the-relationship-between-packaging-adhesives-and-particulate-generation-in-nested-syringe-tubs.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
