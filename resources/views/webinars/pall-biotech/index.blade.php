...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/pall-biotech/pall-biotech-ondemand-og.jpg" />

	<link rel="canonical" href="{{url('pall-biotech-webinar-aug20')}}"/>
	...
	<meta property="og:url" content="{{url('pall-biotech-webinar-aug20')}}" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}webinars/pall-biotech/pall-biotech-logo.png" alt="PALL Biotech" class="ml-2 img-fluid">
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/pall-biotech/pall-biotech-ondemand-banner.jpg" alt="PALL Biotech" title="PALL Biotech" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-4 mb-4">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/pall-biotech/pall-biotech-video-thumb.jpg" alt="Pall Biotech Webinar Video" title="Pall Biotech Webinar Video" class="img-fluid video shadow border text-center" />
			</div>
	    	...
	    	<div class="row">
	    		<div class="col-lg-4 col-md-4 col-sm-12 col-12 person pt-3 text-center">				
	    			<div class="" align="center">
	    				<img src="{{config('app.url')}}webinars/pall-biotech/pall-biotech-tom-watson.jpg" alt="Tom Watson" title="Tom Watson" class="img-fluid border" />
	    				<div class="pt-2">
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{ url('pall-biotech-webinar-aug20-success') }}" method="post" id='writemessage' >
						{{ csrf_field() }}	
						<div class="row">
							<div class="col-md-12">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="{{url('pall-biotech-webinar-aug20')}}" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
