...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/protocol-first/protocol-first-banner.jpg" />

	<link rel="canonical" href="{{url('protocol-first-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('protocol-first-webinar')}}" />
		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-8 my-auto offset-lg-4 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}webinars/protocol-first/protocol-first-logo.png" alt="Protocol First" class="ml-2 img-fluid"> 
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/protocol-first/protocol-first-banner.jpg" alt="Protocol First" title="Protocol First" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/protocol-first/protocol-webinar-video-thumb.jpg" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
			</div>
				...
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-12 col-12 person text-center">
							...
							<img src="{{config('app.url')}}webinars/protocol-first/protocol-first-speaker.jpg" alt="Dr. Hugh Levaux" title="Dr. Hugh Levaux" class="img-fluid">
						</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">						
						<form action="{{ url('protocol-first-webinar-success') }}" method="post" id='writemessage' >
							{{ csrf_field() }}
							<div class="row">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="{{url('protocol-first-webinar')}}" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
