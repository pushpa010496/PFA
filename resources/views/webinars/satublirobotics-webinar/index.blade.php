...
<head>
	...
	<title>Types of robots used in Pharma & its applications in the Pharma Industry</title>
	<!-- Meta Tags -->
	<meta name="description" content="Following the transformation in general industry, the Pharma sector has sucessfully won the challenge of automation pushing by the requirement of aseptic and decontamination." />
	<meta name="keywords" content="" />

	<meta property="og:title" content="Types of robots used in Pharma & its applications in the Pharma Industry" />
	<meta property="og:description" content="Following the transformation in general industry, the Pharma sector has sucessfully won the challenge of automation pushing by the requirement of aseptic and decontamination." />
	<meta property="og:Keywords" content="" />

	<meta property="og:image" content="{{config('app.url')}}webinars/satubli-robotics/staubli-robotics-og-image.jpg" />

	<link rel="canonical" href="{{url('satubli-robotics-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('satubli-robotics-webinar')}}" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}webinars/satubli-robotics/staubli-logo.jpg" alt="satubli-webinar logo" class="ml-2 img-fluid"> 
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/satubli-robotics/Staubli Robotics-banner.jpg" alt="Satubli-Webinar" title="Staubli-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">Types of robots used in Pharma & its applications in the Pharma Industry</h2>

						<p>Following the transformation in general industry, the Pharma sector has sucessfully won the challenge of automation pushing by the requirement of aseptic and decontamination. Robotics became more and more popular because of its flexibility and modularity needs, and also due to the trend of personalized medicine and small batch production. The Pharma factory will keep on moving and will become even more smart, connected and safe. </p>
					</div>
				</div> 
			</div>
			
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/satubli-robotics/staubli-ondemand-video-image.jpg" alt="Staubli Webinar" title="Staubli Webinar" class="img-fluid video shadow border text-center" />
				<div class="p-2 PF-BrdrDDD mb-1 bg-light shadow mt-4" align="center">
					<h3 class="pt-1 pb-1">
						<strong class="TXT-RED font-20">13th July 2021</strong>
						<span class="small text-secondary ml-2 mr-3">(Tuesday)</span>
						<p class="mt-2 mb-0 font-weight-bold font-16">11:30 AM (IST) - 12.30 PM (IST))</p>
					</h3>						
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="{{config('app.url')}}webinars/satubli-robotics/Rudolf Michael Weiss.jpg" alt="Rudolf Michael Weiss" title="Rudolf Michael Weiss" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Rudolf Michael Weiss</strong></h2>
							<p class="gray-text mb-2"><em>Global Head of Pharma & Member of Global Management Team, Germany</em></p>
							<p class="mb-1">Rudolf-Michael Weiss started in the senior management at the Stäubli Robotics Division of the STAUBLI Group in October 2020. He took over the global responsibility for robotic/automation business in pharma and medical devices as Global Head of Pharma and as a Member of the Global Management Team.
After his studies in Stuttgart Rudolf M. Weiss started working at Servotech in 1999. From 2001 on, he was working at Groninger where he was responsible as Marketing Director, Senior Project Manager and Sales Director.
After experiences at FIMA, he decided to go back to pharma and joining Bausch+Ströbel the global leading company for fill/finish equipment 2018 he was announced to be Authorized Officer and Director Sales & Marketing. He can draw on 20 years of experience in the field of Pharma.</p>
						</div> 
					</div>
				</div>
			</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="{{ route('satubliroboticswebinar.post') }}" method="post" id='writemessage' >
						{{ csrf_field() }}
						<div class="row">
							<div class="col-md-12 mb-2">
								<div class="form-group {{ $errors->first('name', 'has-error')}}">
									<input class="form-control" id="name" name="name" placeholder="Full Name *" required=""  value="{{ old('name') }}"  type="text">	
								<input type="hidden" name="type" id="type" value="On-demand Staubli Robotics Webinar">
                    									
                                <input type="hidden" name="formtype" value="modal-form">
                                
                                <input type="hidden" name="thank_message" value="Your On-demand Staubli Robotics Webinar  registration was successfully completed.">
                                
                                <input type="hidden" name="client_message" value="Thank you for showing your interest in Staubli Robotics Webinar">
							...
							<div class="col-md-12 mb-2">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="email_updates">I would like to receive email updates about staubli-webinar products, services and events</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label text-secondary small" for="representative">I have more questions and would like to be contacted by a staubli-webinar representative</label>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="{{url('satubli-robotics-webinar')}}" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
