...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/obviohealth/obviohealth-webinar-banner.jpg" />

	<link rel="canonical" href="{{url('obviohealth-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('obviohealth-webinar')}}" />
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}webinars/obviohealth/obviohealth-webinar-logo.png" alt="obviohealth-webinar-logo" class="ml-2 img-fluid"> 
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/obviohealth/obviohealth-webinar-banner.jpg" alt="obviohealth Webinar" title="obviohealth-Webinar" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3 mb-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/obviohealth/obviohealth-webinar-video-thumb.jpg" alt="Obvio Health" title="Obvio Health" class="img-fluid video shadow border text-center" />
		...
		<div id="videoFormModal" class="modal fade" role="dialog">
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<form action="{{ route('obviohealthwebinar.post') }}" method="post" id='writemessage' >
						{{ csrf_field() }}
						<div class="row">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="{{url('obviohealth-webinar')}}" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
