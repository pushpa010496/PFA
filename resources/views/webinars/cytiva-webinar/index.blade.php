...
<head>
	...
	<title>Cytiva webinar | Free Webinar Online Session</title>
	
	<!-- Meta Tags -->
	<!-- <meta property="title" content="Cytiva webinar | Free Webinar Online Session" /> -->
	<meta name="description" content="Participants get to learn, why filtration plays an important role in purification of contaminants, filter selection, its chemical properties, compatibility" />
	<meta name="keywords" content="Cytiva webinar, Free Webinar Online Session, Daniel McElroy Online Webinar, Giles Barton Online Webinar" />

	<meta property="og:title" content="Cytiva webinar | Free Webinar Online Session" />
	<meta property="og:description" content="Participants get to learn, why filtration plays an important role in purification of contaminants, filter selection, its chemical properties, compatibility" />
	<meta property="og:Keywords" content="Cytiva webinar, Free Webinar Online Session, Daniel McElroy Online Webinar, Giles Barton Online Webinar" />

	<meta property="og:image" content="{{config('app.url')}}webinars/cytiva/cytiva-og-ondemand.jpg" />

	<link rel="canonical" href="{{url('cytiva-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('cytiva-webinar')}}" />
  ...
  @endif
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-8 my-auto offset-lg-5 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}webinars/cytiva/cytiva-logo.jpg" alt="Cytiva" class="ml-2 img-fluid">
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/cytiva/cytiva-banner-ondemand.jpg" alt="Cytiva" title="Cytiva" class="img-fluid shadow" />
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-12 mt-3">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 person">
						<h2 class="font-weight-bold PF-TXTRED font-20">Whatman™ Lab filtration: Media selection and applications</h2> 

						<h3 class="font-weight-bold font-16">Description or Brief about the Webinar/ Title  & What participants will learn</h3> 
						<p>Participants get to learn, why filtration plays an important role in purification of contaminants, filter selection, its chemical properties, compatibility and types of filters.</p>  				
					</div> 
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-12 text-center">
								<div class="p-3 PF-BrdrDDD mb-3 bg-light shadow" align="center">
									<img src="{{config('app.url')}}webinars/cytiva/daniel.jpg" alt="Daniel McElroy" title="Daniel McElroy" class="img-fluid rounded-circle border" />
									<div class="pt-2">
										<p class="person-name TXT-GREEN mb-1">Daniel McElroy</p>
										<p class="gray-text mb-1"><em>Global Senior Product Manager</em></p>
										<p class="small mb-0">Lab Filtration, Cytiva</p>
									</div>   
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-12 text-center">
								<div class="p-3 PF-BrdrDDD mb-3 bg-light shadow" align="center">
									<img src="{{config('app.url')}}webinars/cytiva/dan.jpg" alt="Giles Barton" title="Giles Barton" class="img-fluid rounded-circle border" />
									<div class="pt-2">
										<p class="person-name TXT-GREEN mb-1">Giles Barton</p>
										<p class="gray-text mb-1"><em>Sr. Global Product Manager</em></p>
										<p class="small mb-0">Lab Filtration, Cytiva</p>
									</div> 
								</div>
							</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}/webinars/cytiva/cytiva-video-thumb.jpg" alt="Cytiva Webinar Video" title="Cytiva Webinar Video" class="img-fluid video shadow border text-center" />

				<div class="d-none d-sm-block pt-4"></div>

				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-4">				
						<div class="p-2 PF-BrdrDDD mb-3 shadow" align="center">
							<h2 class="mb- pt-2">
								<small>(Thursday)</small> <strong class="TXT-GREEN ml-2 mr-2">17<sup>th</sup> September 2020,</strong> 11:00 AM (IST)
							</h2>
						</div>
					</div>
				</div>
	...
	<div class="container">	
	    ...
	    <div class="row">
	        <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-2">
	        	<h3 class="font-weight-bold PF-TXTRED font-20">ABOUT SPEAKERS:</h3>
	        </div>
	    </div>
                 
		<div class="row">
			<div class="col-md-12">
			  <h2 class="TXT-GREEN mt-2"><strong>Daniel McElroy</strong></h2>
			  <p class="mb-1">Global Senior Product Manager, Lab Filtration, Cytiva: Dan is Global Senior Product Manager for Lab Filtration focused on the Whatman Syringe and Syringeless portfolio. Dan has been supporting the Whatman filtration and protein separation product portfolio for 11 years. During his 20+ year career in the Life Sciences Industry, he has spent time in Field Application Support, Field Sales, Sales Management and as a bench scientist, working on all aspects of the purification and analysis of Monoclonal Antibodies. Dan holds a bachelor’s degree in Biology.</p>
			</div>


			<div class="col-md-12">
			  <h2 class="TXT-GREEN mt-2"><strong>Giles Barton</strong></h2>
			  <p class="mb-1">Sr. Global Product Manager, Devices: Giles is Global Lead Product Specialist for Lab Filtration and has been supporting the Whatman filtration and separation product portfolio for 30 years. Prior to this, he has spent time in field sales and as a bench scientist. Giles holds a Bachelor’s degree in Biochemistry and a Master’s degree in Communicating Science and Contemporary Issues in Science Learning.</p>
			</div>
		</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="{{ url('cytiva-webinar-success') }}" method="post" id='writemessage' >
							{{ csrf_field() }}
							<div class="row">
								<div class="col-md-12 mb-2">
									<div class="form-group {{ $errors->first('name', 'has-error')}}">
										<input class="form-control" id="name" name="name" placeholder="Full Name *" required=""  value="{{ old('name') }}"  type="text">	
										<input type="hidden" name="type" id="type" value="Cytiva On-demand Webinar" />
										<input type="hidden" name="formtype"  value="modal-form" />
										<input type="hidden" name="thank_message" value="Thank You">
										<input type="hidden" name="client_message" value="Thank You for showing interest in <strong>  Cytiva</strong>">
								...
								<div class="col-md-12 mb-2">
									<div class="form-group">
										<div class="custom-control custom-checkbox mb-1">
											...
											<label class="custom-control-label small" for="email_updates">I would like to receive email updates about Cytiva products, services and events</label>
										</div>
										<div class="custom-control custom-checkbox mb-1">
										...
										<div class="custom-control custom-checkbox mb-1">
											...
											<label class="custom-control-label small" for="representative">I have more questions and would like to be contacted by a Cytiva representative</label>
										</div>
									</div>
								</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="{{url('cytiva-webinar')}}" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
