...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/suez-sievers/suez-sievers-ondemand-og.jpg" />

	<link rel="canonical" href="{{url('suez-sievers-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('suez-sievers-webinar')}}" />
			...
			<div class="row">
				<div class="col-md-8 offset-md-2 mt-4">
					<video width="100%" controls autoplay>
						<source src="{{config('app.url')}}webinars/suez-sievers/ondemand.mp4" type="video/mp4">
					</video>
				</div>
			</div> 
		</div>
