...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/oracle/series3/oracle-series3-ondemand-og-en.jpg" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/oracle/series3/english-ondemand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
