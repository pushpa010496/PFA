...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/oracle/series1/oracle-series1-ondemand-banner-en.jpg" />
	<link rel="canonical" href="{{url('oracle-webinar-series1-english')}}"/>
	...
	<meta property="og:url" content="{{url('oracle-webinar-series1-english')}}" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/oracle/series1/english-ondemand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
