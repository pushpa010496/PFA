...
<head>
	...
	<title>Making the Change: How to prepare for the future of clinical trials? | Oracle | Series-1 | Korean</title>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/oracle/series1/oracle-series1-ondemand-banner-kr.jpg" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/oracle/series1/korea-ondemand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
