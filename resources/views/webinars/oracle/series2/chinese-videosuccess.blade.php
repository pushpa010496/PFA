...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/oracle/series2/oracle-series-2-ondemand-og-cn.jpg" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/oracle/series2/chinese-ondemand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
