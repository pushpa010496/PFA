<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/oracle/oracle-series2-popup-banner-kr.jpg" />
	<link rel="canonical" href="{{url('oracle-webinar-series2-korean')}}"/>
	...
	<meta property="og:url" content="{{url('oracle-webinar-series2-korean')}}" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/oracle/series2/korea-ondemand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
