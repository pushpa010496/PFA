...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/suez-ozonia/suez_og-image.jpg" />

	<link rel="canonical" href="{{url('suez-ozonia-ozone-systems-webinar-success')}}"/>
	...
	<meta property="og:url" content="{{url('suez-ozonia-ozone-systems-webinar-success')}}" />
			...
			<div class="row">
				<div class="col-md-8 offset-md-2 mt-4">
					<video width="100%" controls autoplay>
						<source src="{{config('app.url')}}webinars/suez-ozonia/suez-ozonia-video.mp4" type="video/mp4">
					</video>
				</div>
			</div> 
		</div>
