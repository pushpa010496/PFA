                ...
                <div class="row">
                  ...
                  <div class="col BookList mb-2">
                    ...
                    <div class="card shadow" style="width:180px !important;">                    
                      ...
                      <a id="show_confirm" data-toggle="modal" href="#" data-target="#modal_confirm" data-id ="{{ Str::slug($book->issue->id) }}" data-eid ="{{ $book->id }}" data-title ="{{ $book->issue->issue_no }}">

                        <img src="{{ config('app.url').'ebooks/'. Str::slug($book->issue->issue_no).'/'.$book->magazine_image }} " alt="" title="" class="img-fluid">
