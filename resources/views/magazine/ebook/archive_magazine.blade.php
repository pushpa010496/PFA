                      ...
                      <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        ...
                        <div class="row">  
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-8 col-12">
                            ...
                            <li class="ml-3"><a href="#{{Str::slug($category->name)}}">{{ $category->name }}</a></li>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 title-list">
                ...
                @foreach($ebook->issue->categories as $category)                                         
                 ...
                 <div class="pt-4">
                  ...
                  <h2 class="PF-Caps PF-TXTRED" id="{{ Str::slug($category->name) }}">
                  ...
                  @foreach($articles as $article)
                    ...
                    @if($article->category_id ==  $category->id)
                      ...
                      <p class="PF-TXTBlk">{{\Illuminate\Support\Str::limit(preg_replace('/[^a-zA-Z\s]/', '', strip_tags(html_entity_decode(ucfirst($article->short_description)))),$limit = 350, $end = '...') }}</p>
