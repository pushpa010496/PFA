 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-12 title-list">
 	...
 	<p class="m-0 text-justify text-dark">{{ \Illuminate\Support\Str::limit(preg_replace('/[^a-zA-Z\s]/', '', strip_tags(html_entity_decode(ucfirst($val->short_description)))),$limit = 350, $end = '...') }}</p> 
 </div> 
 @endforeach
