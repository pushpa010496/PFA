...
<script type="application/ld+json">
{
  ...
  "itemListElement": [{
    ...
    "@type": "ListItem", 
    "position": 3, 
    "name": "{{strip_tags(html_entity_decode(ucfirst($data->title))) }}",
    "item": "{{Request::url();}}"  
  }]
}
</script>
        ...
        <div class="row PF-MobP030">
          ...
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active  text-capitalize" aria-current="page"><a href="{{url(Request::segment(1))}}">{{$data->category->name}} </a> </li>
