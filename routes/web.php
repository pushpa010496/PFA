...
use App\Http\Controllers\industryupdates\ReportsController;
...
Route::get('strategy/sitemap.xml', [SitemapController::class,'strategy']);
Route::get('research-development/sitemap.xml', [SitemapController::class,'researchdevelopment']);
Route::get('clinical-trials/sitemap.xml', [SitemapController::class,'clinicaltrials']);
Route::get('manufacturing/sitemap.xml', [SitemapController::class,'manufacturing']);
Route::get('information-technology/sitemap.xml', [SitemapController::class,'informationtechnology']);
Route::get('expert-talk/sitemap.xml', [SitemapController::class,'experttalk']);
...
Route::get('pharma-reports/sitemap.xml', [SitemapController::class,'pharmareports']);
...
Route::get('editorial-calendars',[FormController::class,'editorialCalendar'])->name('editorialcalendar');
Route::post('editorial-calendars',[FormController::class,'editorialCalendar'])->name('editorialcalendar.post');
Route::get('editorial-calendars/success',[FormController::class,'editorialCalendarSuccess'])->name('editorialcalendar.success');
...
Route::get('subscribe',[FormController::class,'magazineSubscribe1post'])->name('subscribe');
Route::post('magazine-subscribe1-post',[FormController::class,'magazineSubscribe1post']); 
...
Route::get('our-services',[FormController::class,'ourServices'])->name('ourServices');
Route::post('our-services',[FormController::class,'ourServices'])->name('ourServices.post');
Route::get('our-services',[FormController::class,'ourServices'])->name('ourServices.success');
...
Route::get('waters-bioprocessing-lab-webinar-June14',[WebinarController::class,'watersBioprocessinglabwebinarJune14']);
Route::post('waters-bioprocessing-lab-webinar-June14-success',[WebinarController::class,'watersBioprocessinglabwebinarJune14'])->name('watersBioprocessinglabwebinarJune14.post');
Route::get('waters-bioprocessing-lab-webinar-June14-success',[WebinarController::class,'watersBioprocessinglabwebinarJune14'])->name('watersBioprocessinglabwebinarJune14.success');
...
Route::get("/pharma-machinery-assessment",[ZebraController::class,'PharmaMachineryAssessment']);
// Route::post('/pharma-machinery-assessment-post','ZebraaController@postForm')->name('healthcarezebra.post');
Route::post('/pharma-machinery-assessment-post',[ZebraController::class,'PharmaMachineryAssessment'])->name('PharmaMachineryAssessment.post');
Route::get('/pharma-machinery-assessment-success',[ZebraController::class,'PharmaMachineryAssessment'])->name('PharmaMachineryAssessment.success');

Route::get("/pharma-software-assessment",[ZebraController::class,'PharmaSoftwareAssessment']);
Route::post('/pharma-software-assessment-post',[ZebraController::class,'PharmaSoftwareAssessment'])->name('PharmaSoftwareAssessment.post');
Route::get('/pharma-software-assessment-success',[ZebraController::class,'PharmaSoftwareAssessment'])->name('pharmasoftwareassessment.success');
...
Route::get('/cpc-industry-assessment',[ZebraController::class,'cpcindustryAssessment']);
Route::post('/cpc-industry-assessment-post',[ZebraController::class,'cpcindustryAssessment'])->name('cpcindustryAssessment.post');
Route::get('/cpc-industry-assessment-success',[ZebraController::class,'cpcindustryAssessmentsuccess'])->name('cpcindustryAssessment.success');
...
Route::get('/en/thermofisher-cho-scalability',[FlatPagesController::class,'thermofisherchoScalability']);
Route::post('/en/thermofisher-cho-scalability-post',[FlatPagesController::class,'thermofisherchoScalability'])->name('thermofisherchoScalability.post');
Route::get('/en/thermofisher-cho-scalability-success',[FlatPagesController::class,'thermofisherchoScalability'])->name('thermofisherchoScalability.success');


Route::get('/thermo-fisher-cell-and-gene-therapy-development-digital-pcr',[FlatPagesController::class,'thermoFishercellDevelopmentdigitalpcr']);
Route::post('/thermo-fisher-cell-and-gene-therapy-development-digital-pcr-success',[FlatPagesController::class,'thermoFishercellDevelopmentdigitalpcr'])->name('thermoFishercellDevelopmentdigitalpcr.post');
Route::get('/thermo-fisher-cell-and-gene-therapy-development-digital-pcr-technicalt-literatures-success',[FlatPagesController::class,'thermoFishercellDevelopmentdigitalpcr'])->name('thermoFishercellDevelopmentdigitalpcrliteratures.success');
Route::get('/thermo-fisher-cell-and-gene-therapy-development-digital-pcr-technicalt-absolute-q-viraltiter-dPCR-assays-flyer-success',[FlatPagesController::class,'thermoFishercellDevelopmentdigitalpcr'])->name('thermoFishercellDevelopmentdigitalpcrflyer.success');
Route::get('/thermo-fisher-cell-and-gene-therapy-development-digital-pcr-fully-integrated-dPCR-system-for-viral-titer-quantification-poster-success',[FlatPagesController::class,'thermoFishercellDevelopmentdigitalpcr'])->name('thermoFishercellDevelopmentdigitalpcrflyerposter.success');
Route::post('/thermo-fisher-cell-and-gene-therapy-development-digital-pcr-characterization-of-aav-genomic-titer-by-dPCR-poster-success',[FlatPagesController::class,'thermoFishercellDevelopmentdigitalpcr'])->name('thermoFishercellDevelopmentdigitalpcrdPCRposter.post');
Route::post('/thermo-fisher-cell-and-gene-therapy-development-digital-pcr-absoluteq-viral-titer-assays-user-guide-success',[FlatPagesController::class,'thermoFishercellDevelopmentdigitalpcr'])->name('thermoFishercellDevelopmentdigitalpcrguide.post');
Route::get('/thermo-fisher-cell-and-gene-therapy-development-digital-pcr-absolute-q-product-brochure-success',[FlatPagesController::class,'thermoFishercellDevelopmentdigitalpcr'])->name('thermoFishercellDevelopmentdigitalpcrbrochure.success');



Route::get('/thermo-fisher-manufacturing-site-iso-certifications',[FlatPagesController::class,'thermofisherManufacturingsiteiso']);

Route::get('/biozen-phenomenex',[FlatPagesController::class,'biozenPhenomenex']);
Route::post('/biozen-phenomenex-post',[FlatPagesController::class,'biozenPhenomenex'])->name('biozenPhenomenex.post');
Route::get('/biozen-phenomenex-success',[FlatPagesController::class,'biozenPhenomenex'])->name('biozenPhenomenex.success');
...
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-mabs',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesMabs']);
Route::post('thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-mabs-success',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesMabs'])->name('thermoFisherQualtrakPcrMsModalitiesMabs.post');
Route::get('thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-mabs-demo-success',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesMabs'])->name('thermoFisherQualtrakPcrMsModalitiesMabsdemo.success');
Route::get('thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-mabs-white-paper-success',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesMabs'])->name('thermoFisherQualtrakPcrMsModalitiesMabswhitepaper.success');

Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-vaccines',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesVaccines']);
Route::post('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-vaccines-success',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesVaccines'])->name('thermoFisherQualtrakPcrMsModalitiesVaccines.post');
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-vaccines-demo-success',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesVaccines'])->name('thermoFisherQualtrakPcrMsModalitiesVaccinesdemo.success');
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-vaccines-white-paper-success',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesVaccines'])->name('thermoFisherQualtrakPcrMsModalitiesVaccineswhitepaper.success');


Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-cell-&-gene',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesCellGene']);
Route::post('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-cell-&-gene-success',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesCellGene'])->name('thermoFisherQualtrakPcrMsModalitiesCellGene.post');
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-cell-&-gene-statement-of-quality-success',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesCellGene'])->name('thermoFisherQualtrakPcrMsModalitiesCellGenestatement.success');
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-cell-&-gene-infographic-success',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesCellGene'])->name('thermoFisherQualtrakPcrMsModalitiesCellGeneinfographic.success');


Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/contact-qualtrak',[FlatPagesController::class,'thermoFisherQualtrakContact']);
Route::post('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/contact-qualtrak-success',[FlatPagesController::class,'thermoFisherQualtrakContact'])->name('thermoFisherQualtrakContact.post');
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/contact-qualtrak-success',[FlatPagesController::class,'thermoFisherQualtrakContact'])->name('thermoFisherQualtrakContact.success');

Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23-jp',[FlatPagesController::class,'thermoFisherQualtrakPcrMsjp']);

Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-jp',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesJp']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-mabs-jp',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesMabsJp']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-vaccines-jp',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesVaccinesJp']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-cell-&-gene-jp',[FlatPagesController::class,'thermoFisherQualtrakPcrMsodalitiesCellGeneJp']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/contact-qualtrak-jp',[FlatPagesController::class,'thermoFisherQualtrakPcrMsContactQualtrakjp']);


Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23-kr',[FlatPagesController::class,'thermoFisherQualtrakPcrMskr']);

Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-kr',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitieskr']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-mabs-kr',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesMabskr']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-vaccines-kr',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesVaccineskr']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-cell-&-gene-kr',[FlatPagesController::class,'thermoFisherQualtrakPcrMsodalitiesCellGenekr']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/contact-qualtrak-kr',[FlatPagesController::class,'thermoFisherQualtrakPcrMsContactQualtrakkr']);


Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23-cn',[FlatPagesController::class,'thermoFisherQualtrakPcrMscn']);

Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-cn',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiescn']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-mabs-cn',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesMabscn']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-vaccines-cn',[FlatPagesController::class,'thermoFisherQualtrakPcrMsModalitiesVaccinescn']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/modalities-cell-&-gene-cn',[FlatPagesController::class,'thermoFisherQualtrakPcrMsodalitiesCellGenecn']);
Route::get('/thermo-fisher-qualtrak-pcr-ms-r1-fb23/contact-qualtrak-cn',[FlatPagesController::class,'thermoFisherQualtrakPcrMsContactQualtrakcn']);

Route::get('/korber-enabling-digitization-pharma-biotech-production-pasx-mes',[FlatPagesController::class,'korberenablingdigitizationpharmabiotechproductionPasxmes']);
Route::post('/korber-enabling-digitization-pharma-biotech-production-pasx-mes-success',[FlatPagesController::class,'korberenablingdigitizationpharmabiotechproductionPasxmes'])->name('korberenablingdigitizationpharmabiotechproductionPasxmes.post');
Route::get('/korber-enabling-digitization-pharma-biotech-production-pasx-mes-success',[FlatPagesController::class,'korberenablingdigitizationpharmabiotechproductionPasxmes'])->name('korberenablingdigitizationpharmabiotechproductionPasxmes.success');

Route::get('/tf-single-use-technologies',[FlatPagesController::class,'tfSingleUseTechnologies']);
Route::post('/tf-single-use-technologies-success',[FlatPagesController::class,'tfSingleUseTechnologies'])->name('tfSingleUseTechnologies.post');
Route::get('/tf-single-use-technologies-success',[FlatPagesController::class,'tfSingleUseTechnologies'])->name('tfSingleUseTechnologies.success');


Route::get('/waters-bioprocessing-content-syndication',[FlatPagesController::class,'watersBioprocessingContentSyndication']);
Route::post('/waters-bioprocessing-content-syndication-success',[FlatPagesController::class,'watersBioprocessingContentSyndication'])->name('watersBioprocessingContentSyndication.post');
Route::get('/waters-bioprocessing-content-syndication-success',[FlatPagesController::class,'watersBioprocessingContentSyndication'])->name('watersBioprocessingContentSyndication.success');

Route::get('/merck-mobius-single-use-technology',[FlatPagesController::class,'merckSingleusetecchnology']);
Route::post('/merck-mobius-single-use-technology-success',[FlatPagesController::class,'merckSingleusetecchnology'])->name('merckSingleusetecchnology.post');
Route::get('/merck-mobius-single-use-technology-success',[FlatPagesController::class,'merckSingleusetecchnology'])->name('merckSingleusetecchnology.success');

Route::get('/merck-mobius-single-use-infographic',[FlatPagesController::class,'merckmobiussingleuseInfographic']);
Route::post('/merck-mobius-single-use-infographic-success',[FlatPagesController::class,'merckmobiussingleuseInfographic'])->name('merckmobiussingleuseInfographic.post');
Route::get('/merck-mobius-single-use-infographic-success',[FlatPagesController::class,'merckmobiussingleuseInfographic'])->name('merckmobiussingleuseInfographic.success');


Route::get('/merck-mobius-single-use-new-innovations',[FlatPagesController::class,'merckmobiussingleuseultimusfilmtechBrief']);
Route::post('/merck-mobius-single-use-new-innovations-success',[FlatPagesController::class,'merckmobiussingleuseultimusfilmtechBrief'])->name('merckmobiussingleuseultimusfilmtechBrief.post');
Route::get('/merck-mobius-single-use-new-innovations-success',[FlatPagesController::class,'merckmobiussingleuseultimusfilmtechBrief'])->name('merckmobiussingleuseultimusfilmtechBrief.success');


Route::get('/merck-mobius-single-use-technology-your-supply-our-focus',[FlatPagesController::class,'merckmobiusSterilizationofsingleuseAssemblies']);
Route::post('/merck-mobius-single-use-technology-your-supply-our-focus-success',[FlatPagesController::class,'merckmobiusSterilizationofsingleuseAssemblies'])->name('merckmobiusSterilizationofsingleuseAssemblies.post');
Route::get('/merck-mobius-single-use-technology-your-supply-our-focus-success',[FlatPagesController::class,'merckmobiusSterilizationofsingleuseAssemblies'])->name('merckmobiusSterilizationofsingleuseAssemblies.success');

Route::get('/merck-mobius-single-use-contact-us',[FlatPagesController::class,'merckmobiussingleuseContactUs']);
Route::post('/merck-mobius-single-use-contact-us-success',[FlatPagesController::class,'merckmobiussingleuseContactUs'])->name('merckmobiussingleuseContactUs.post');
Route::get('/merck-mobius-single-use-contact-us-success',[FlatPagesController::class,'merckmobiussingleuseContactUs'])->name('merckmobiussingleuseContactUs.success');

Route::get('/merck-mobius-single-use-innovations-ultimus-film',[FlatPagesController::class,'merckmobiusultimusfilm']);
Route::post('/merck-mobius-single-use-innovations-ultimus-film-success',[FlatPagesController::class,'merckmobiusultimusfilm'])->name('merckmobiusultimusfilm.post');
Route::get('/merck-mobius-single-use-innovations-ultimus-film-success',[FlatPagesController::class,'merckmobiusultimusfilm'])->name('merckmobiusultimusfilm.success');

Route::get('/merck-mobius-single-use-innovations-novaseptum-sure',[FlatPagesController::class,'merckmobiusnovaseptumSure']);
Route::post('/merck-mobius-single-use-innovations-novaseptum-success',[FlatPagesController::class,'merckmobiusnovaseptumSure'])->name('merckmobiusnovaseptumSure.post');
Route::get('/merck-mobius-single-use-innovations-novaseptum-success',[FlatPagesController::class,'merckmobiusnovaseptumSure'])->name('merckmobiusnovaseptumSure.success');

Route::get('/thermofisher-chemical-improving-separation',[FlatPagesController::class,'thermofisherchemicalimprovingSeparation']);
Route::post('/thermofisher-chemical-improving-separation-success',[FlatPagesController::class,'thermofisherchemicalimprovingSeparation'])->name('thermofisherchemicalimprovingSeparation.post');
Route::get('/thermofisher-chemical-improving-separation-success',[FlatPagesController::class,'thermofisherchemicalimprovingSeparation'])->name('thermofisherchemicalimprovingSeparation.success');

Route::get('/thermofisher-chemicals-pharmaceutical-applications',[FlatPagesController::class,'thermofisherchemicalsPharmaceuticalApplications']);
Route::post('/thermofisher-chemicals-pharmaceutical-applications-success',[FlatPagesController::class,'thermofisherchemicalsPharmaceuticalApplications'])->name('thermofisherchemicalsPharmaceuticalApplications.post');
Route::get('/thermofisher-chemicals-pharmaceutical-applications-success',[FlatPagesController::class,'thermofisherchemicalsPharmaceuticalApplications'])->name('thermofisherchemicalsPharmaceuticalApplications.success');

Route::get('/thermofisher-chemicals-chromatography-solvents',[FlatPagesController::class,'thermofisherchemicalsChromatographysolvents']);
Route::post('/thermofisher-chemicals-chromatography-solvents-success',[FlatPagesController::class,'thermofisherchemicalsChromatographysolvents'])->name('thermofisherchemicalsChromatographysolvents.post');
Route::get('/thermofisher-chemicals-chromatography-solvents-success',[FlatPagesController::class,'thermofisherchemicalsChromatographysolvents'])->name('thermofisherchemicalsChromatographysolvents.success');


Route::get('/thermofisher-chemicals-mobile-phase-solvents-and-reagents',[FlatPagesController::class,'thermofisherchemicalsmobilephasesolventsandReagents']);
Route::post('/thermofisher-chemicals-mobile-phase-solvents-and-reagents-success',[FlatPagesController::class,'thermofisherchemicalsmobilephasesolventsandReagents'])->name('thermofisherchemicalsmobilephasesolventsandReagents.post');
Route::get('/thermofisher-chemicals-mobile-phase-solvents-and-reagents-success',[FlatPagesController::class,'thermofisherchemicalsmobilephasesolventsandReagents'])->name('thermofisherchemicalsmobilephasesolventsandReagents.success');


Route::get('/tf-downstream-purification',[FlatPagesController::class,'tfdownstreampurification']);
Route::post('/tf-downstream-purification-success',[FlatPagesController::class,'tfdownstreampurification'])->name('tfdownstreampurification.post');
Route::get('/tf-downstream-purification-success',[FlatPagesController::class,'tfdownstreampurification'])->name('tfdownstreampurification.success');

Route::get('/tf-downstream-purification/jp',[FlatPagesController::class,'tfdownstreampurificationJP']);
Route::get('/tf-downstream-purification/cn',[FlatPagesController::class,'tfdownstreampurificationCN']);
Route::get('/tf-downstream-purification/kr',[FlatPagesController::class,'tfdownstreampurificationKR']);


Route::get('/mercks-mobius',[FlatPagesController::class,'mercksmobius']);
Route::post('/mercks-mobius-success',[FlatPagesController::class,'mercksmobius'])->name('mercksmobius.post');
Route::get('/mercks-mobius-success',[FlatPagesController::class,'mercksmobius'])->name('mercksmobius.success');



Route::get('/thermofisher-chemical-custom-bulk-and-analytical-solvents',[FlatPagesController::class,'thermofisherChemicalCustomBulkAndAnalyticalSolvents']);
Route::post('/thermofisher-chemical-custom-bulk-and-analytical-solvents-success',[FlatPagesController::class,'thermofisherChemicalCustomBulkAndAnalyticalSolvents'])->name('thermofisherChemicalCustomBulkAndAnalyticalSolvents.post');
Route::get('/thermofisher-chemical-custom-bulk-and-analytical-solvents-success',[FlatPagesController::class,'thermofisherChemicalCustomBulkAndAnalyticalSolvents'])->name('thermofisherChemicalCustomBulkAndAnalyticalSolvents.success');



Route::get('/thermofisher-chemical-improving-separation-kr',[FlatPagesController::class,'thermofisherchemicalimprovingseparationkr']);
Route::post('/thermofisher-chemical-improving-separation-kr-success',[FlatPagesController::class,'thermofisherchemicalimprovingseparationkr'])->name('thermofisherchemicalimprovingseparationkr.post');
Route::get('/thermofisher-chemical-improving-separation-kr-success',[FlatPagesController::class,'thermofisherchemicalimprovingseparationkr'])->name('thermofisherchemicalimprovingseparationkr.success');

Route::get('/thermofisher-chemicals-pharmaceutical-applications-kr',[FlatPagesController::class,'thermofisherchemicalspharmaceuticalapplicationskr']);
Route::post('/thermofisher-chemicals-pharmaceutical-applications-kr-success',[FlatPagesController::class,'thermofisherchemicalspharmaceuticalapplicationskr'])->name('thermofisherchemicalspharmaceuticalapplicationskr.post');
Route::get('/thermofisher-chemicals-pharmaceutical-applications-kr-success',[FlatPagesController::class,'thermofisherchemicalspharmaceuticalapplicationskr'])->name('thermofisherchemicalspharmaceuticalapplicationskr.success');


Route::get('/thermofisher-chemical-custom-bulk-and-analytical-solvents-kr',[FlatPagesController::class,'thermofisherchemicalcustombulkandanalyticalsolventskr']);
Route::post('/thermofisher-chemical-custom-bulk-and-analytical-solvents-kr-success',[FlatPagesController::class,'thermofisherchemicalcustombulkandanalyticalsolventskr'])->name('thermofisherchemicalcustombulkandanalyticalsolventskr.post');
Route::get('/thermofisher-chemical-custom-bulk-and-analytical-solvents-kr-success',[FlatPagesController::class,'thermofisherchemicalcustombulkandanalyticalsolventskr'])->name('thermofisherchemicalcustombulkandanalyticalsolventskr.success');

Route::get('/thermofisher-chemicals-chromatography-solvents-kr',[FlatPagesController::class,'thermofisherchemicalschromatographysolventskr']);
Route::post('/thermofisher-chemicals-chromatography-solvents-kr-success',[FlatPagesController::class,'thermofisherchemicalschromatographysolventskr'])->name('thermofisherchemicalschromatographysolventskr.post');
Route::get('/thermofisher-chemicals-chromatography-solvents-kr-success',[FlatPagesController::class,'thermofisherchemicalschromatographysolventskr'])->name('thermofisherchemicalschromatographysolventskr.success');

Route::get('/thermofisher-chemicals-mobile-phase-solvents-and-reagents-kr',[FlatPagesController::class,'thermofisherchemicalsmobilephasesolventsandreagentskr']);
Route::post('/thermofisher-chemicals-mobile-phase-solvents-and-reagents-kr-success',[FlatPagesController::class,'thermofisherchemicalsmobilephasesolventsandreagentskr'])->name('thermofisherchemicalsmobilephasesolventsandreagentskr.post');
Route::get('/thermofisher-chemicals-mobile-phase-solvents-and-reagents-kr-success',[FlatPagesController::class,'thermofisherchemicalsmobilephasesolventsandreagentskr'])->name('thermofisherchemicalsmobilephasesolventsandreagentskr.success');

Route::get('/thermofisher-chemical-improving-separation-jp',[FlatPagesController::class,'thermofisherchemicalimprovingSeparationjp']);
Route::post('/thermofisher-chemical-improving-separation-jp-success',[FlatPagesController::class,'thermofisherchemicalimprovingSeparationjp'])->name('thermofisherchemicalimprovingSeparationjp.post');
Route::get('/thermofisher-chemical-improving-separation-jp-success',[FlatPagesController::class,'thermofisherchemicalimprovingSeparationjp'])->name('thermofisherchemicalimprovingSeparationjp.success');

Route::get('/thermofisher-chemicals-pharmaceutical-applications-jp',[FlatPagesController::class,'thermofisherchemicalspharmaceuticalapplicationsjp']);
Route::post('/thermofisher-chemicals-pharmaceutical-applications-jp-success',[FlatPagesController::class,'thermofisherchemicalspharmaceuticalapplicationsjp'])->name('thermofisherchemicalspharmaceuticalapplicationsjp.post');
Route::get('/thermofisher-chemicals-pharmaceutical-applications-jp-success',[FlatPagesController::class,'thermofisherchemicalspharmaceuticalapplicationsjp'])->name('thermofisherchemicalspharmaceuticalapplicationsjp.success');

Route::get('/thermofisher-chemical-custom-bulk-and-analytical-solvents-jp',[FlatPagesController::class,'thermofisherchemicalcustombulkandanalyticalsolventsjp']);
Route::post('/thermofisher-chemical-custom-bulk-and-analytical-solvents-jp-success',[FlatPagesController::class,'thermofisherchemicalcustombulkandanalyticalsolventsjp'])->name('thermofisherchemicalcustombulkandanalyticalsolventsjp.post');
Route::get('/thermofisher-chemical-custom-bulk-and-analytical-solvents-jp-success',[FlatPagesController::class,'thermofisherchemicalcustombulkandanalyticalsolventsjp'])->name('thermofisherchemicalcustombulkandanalyticalsolventsjp.success');

Route::get('/thermofisher-chemicals-chromatography-solvents-jp',[FlatPagesController::class,'thermofisherchemicalschromatographysolventsjp']);
Route::post('/thermofisher-chemicals-chromatography-solvents-jp-success',[FlatPagesController::class,'thermofisherchemicalschromatographysolventsjp'])->name('thermofisherchemicalschromatographysolventsjp.post');
Route::get('/thermofisher-chemicals-chromatography-solvents-jp-success',[FlatPagesController::class,'thermofisherchemicalschromatographysolventsjp'])->name('thermofisherchemicalschromatographysolventsjp.success');

Route::get('/thermofisher-chemicals-mobile-phase-solvents-and-reagents-jp',[FlatPagesController::class,'thermofisherchemicalsmobilephasesolventsandreagentsjp']);
Route::post('/thermofisher-chemicals-mobile-phase-solvents-and-reagents-jp-success',[FlatPagesController::class,'thermofisherchemicalsmobilephasesolventsandreagentsjp'])->name('thermofisherchemicalsmobilephasesolventsandreagentsjp.post');
Route::get('/thermofisher-chemicals-mobile-phase-solvents-and-reagents-jp-success',[FlatPagesController::class,'thermofisherchemicalsmobilephasesolventsandreagentsjp'])->name('thermofisherchemicalsmobilephasesolventsandreagentsjp.success');

Route::get('/lonza-capsugel-enprotect-capsule',[FlatPagesController::class,'lonzacapsugelenprotectcapsule']);
Route::post('/lonza-capsugel-enprotect-capsule-success',[FlatPagesController::class,'lonzacapsugelenprotectcapsule'])->name('lonzacapsugelenprotectcapsule.post');
Route::get('/lonza-capsugel-enprotect-capsule-success',[FlatPagesController::class,'lonzacapsugelenprotectcapsule'])->name('lonzacapsugelenprotectcapsule.success');

Route::get('/en/thermofisher-peptone-vaccine-app-note',[FlatPagesController::class,'thermofisherpeptonevaccineappnote']);
Route::post('/en/thermofisher-peptone-vaccine-app-note-success',[FlatPagesController::class,'thermofisherpeptonevaccineappnote'])->name('thermofisherpeptonevaccineappnote.post');
Route::get('/en/thermofisher-peptone-vaccine-app-note-success',[FlatPagesController::class,'thermofisherpeptonevaccineappnote'])->name('thermofisherpeptonevaccineappnote.success');



Route::get('/sartorius-octet-systems',[FlatPagesController::class,'sartoriusoctetsystems']);




Route::get('/sartorius-bli-spr',[FlatPagesController::class,'sartoriusblispr']);
Route::post('/sartorius-bli-spr-success',[FlatPagesController::class,'sartoriusblispr'])->name('sartoriusblispr.post');
Route::get('/sartorius-bli-spr-success',[FlatPagesController::class,'sartoriusblispr'])->name('sartoriusblispr.success');


Route::get('/thermofisher-protein-and-cell-flow-cytometry',[FlatPagesController::class,'thermofisherproteinandcellflowcytometry']);
Route::post('/thermofisher-protein-and-cell-flow-cytometry-success',[FlatPagesController::class,'thermofisherproteinandcellflowcytometry'])->name('thermofisherproteinandcellflowcytometry.post');
Route::get('/thermofisher-protein-and-cell-flow-cytometry-success',[FlatPagesController::class,'thermofisherproteinandcellflowcytometry'])->name('thermofisherproteinandcellflowcytometry.success');


Route::get('/thermofisher-protein-and-cell-flow-cytometry-protocols',[FlatPagesController::class,'thermofisherproteinandcellflowcytometryprotocols']);
Route::post('/thermofisher-protein-and-cell-flow-cytometry-protocols-success',[FlatPagesController::class,'thermofisherproteinandcellflowcytometryprotocols'])->name('thermofisherproteinandcellflowcytometryprotocols.post');
Route::get('/thermofisher-protein-and-cell-flow-cytometry-protocols-success',[FlatPagesController::class,'thermofisherproteinandcellflowcytometryprotocols'])->name('thermofisherproteinandcellflowcytometryprotocols.success');

Route::get('/thermofisher-protein-and-cell-attune-cytpix-flow-cytometer',[FlatPagesController::class,'thermofisherproteinandcellattunecytpixflowcytometer']);
Route::post('/thermofisher-protein-and-cell-attune-cytpix-flow-cytometer-success',[FlatPagesController::class,'thermofisherproteinandcellattunecytpixflowcytometer'])->name('thermofisherproteinandcellattunecytpixflowcytometer.post');
Route::get('/thermofisher-protein-and-cell-attune-cytpix-flow-cytometer-success',[FlatPagesController::class,'thermofisherproteinandcellattunecytpixflowcytometer'])->name('thermofisherproteinandcellattunecytpixflowcytometer.success');



Route::get('/thermofisher-protein-and-cell-flow-cytometer-evalution-guide',[FlatPagesController::class,'thermofisherproteinandcellflowcytometerevalutionguide']);
Route::post('/thermofisher-protein-and-cell-flow-cytometer-evalution-guide-success',[FlatPagesController::class,'thermofisherproteinandcellflowcytometerevalutionguide'])->name('thermofisherproteinandcellflowcytometerevalutionguide.post');
Route::get('/thermofisher-protein-and-cell-flow-cytometer-evalution-guide-success',[FlatPagesController::class,'thermofisherproteinandcellflowcytometerevalutionguide'])->name('thermofisherproteinandcellflowcytometerevalutionguide.success');


Route::get('/thermofisher-rapid-mycoplasma-testing',[FlatPagesController::class,'thermofisherrapidmycoplasmatesting']);
Route::post('/thermofisher-rapid-mycoplasma-testing-success',[FlatPagesController::class,'thermofisherrapidmycoplasmatesting'])->name('thermofisherrapidmycoplasmatesting.post');
Route::get('/thermofisher-rapid-mycoplasma-testing-success',[FlatPagesController::class,'thermofisherrapidmycoplasmatesting'])->name('thermofisherrapidmycoplasmatesting.success');


Route::get('/boras-extrusion-spheronization-engineered-for-todays-controlled-release-forms',[FlatPagesController::class,'borasextrusionspheronizationengineeredfortodayscontrolledreleaseforms']);
Route::post('/boras-extrusion-spheronization-engineered-for-todays-controlled-release-forms-success',[FlatPagesController::class,'borasextrusionspheronizationengineeredfortodayscontrolledreleaseforms'])->name('borasextrusionspheronizationengineeredfortodayscontrolledreleaseforms.post');
Route::get('/boras-extrusion-spheronization-engineered-for-todays-controlled-release-forms-success',[FlatPagesController::class,'borasextrusionspheronizationengineeredfortodayscontrolledreleaseforms'])->name('borasextrusionspheronizationengineeredfortodayscontrolledreleaseforms.success');


Route::get('/thermofisher-peptone-vaccine-app-note-jp',[FlatPagesController::class,'thermofisherpeptonevaccineappnotejp']);

Route::get('/thermofisher-peptone-vaccine-app-note-cn',[FlatPagesController::class,'thermofisherpeptonevaccineappnotecn']);

Route::get('/thermofisher-peptone-vaccine-app-note-kr',[FlatPagesController::class,'thermofisherpeptonevaccineappnotekr']);


Route::get('/mercks-ultimus-films',[FlatPagesController::class,'mercksultimusfilms']);
Route::post('/mercks-ultimus-films-success',[FlatPagesController::class,'mercksultimusfilms'])->name('mercksultimusfilms.post');
Route::get('/mercks-ultimus-films-success',[FlatPagesController::class,'mercksultimusfilms'])->name('mercksultimusfilms.success');

Route::get('/thermofisher-panel-design-service',[FlatPagesController::class,'thermofisherpaneldesignservice']);
Route::post('/thermofisher-panel-design-service-success',[FlatPagesController::class,'thermofisherpaneldesignservice'])->name('thermofisherpaneldesignservice.post');
Route::get('/thermofisher-panel-design-service-success',[FlatPagesController::class,'thermofisherpaneldesignservice'])->name('thermofisherpaneldesignservice.success');


Route::get('/single-use-support-gmbh-whitepaper',[FlatPagesController::class,'singleusesupportgmbhwhitepaper']);
Route::post('/single-use-support-gmbh-whitepaper-success',[FlatPagesController::class,'singleusesupportgmbhwhitepaper'])->name('singleusesupportgmbhwhitepaper.post');
Route::get('/single-use-support-gmbh-whitepaper-success',[FlatPagesController::class,'singleusesupportgmbhwhitepaper'])->name('singleusesupportgmbhwhitepaper.success');

Route::get('/medable-the-digital-future-is-now',[FlatPagesController::class,'medablethedigitalfutureisnow']);
Route::post('/medable-the-digital-future-is-now-success',[FlatPagesController::class,'medablethedigitalfutureisnow'])->name('medablethedigitalfutureisnow.post');
Route::get('/medable-the-digital-future-is-now-success',[FlatPagesController::class,'medablethedigitalfutureisnow'])->name('medablethedigitalfutureisnow.success');

Route::get('/merck-single-use-supply-program',[FlatPagesController::class,'mercksingleusesupplyprogram']);

Route::post('/merck-single-use-supply-program-success',[FlatPagesController::class,'mercksingleusesupplyprogram'])->name('mercksingleusesupplyprogram.post');

Route::get('/merck-single-use-supply-program-success',[FlatPagesController::class,'mercksingleusesupplyprogram'])->name('mercksingleusesupplyprogram.success');

Route::get('/eppendorf-cell-therapy',[FlatPagesController::class,'eppendorfcelltherapy']);
Route::post('/eppendorf-cell-therapy-success',[FlatPagesController::class,'eppendorfcelltherapy'])->name('eppendorfcelltherapy.post');
Route::get('/eppendorf-cell-therapy-success',[FlatPagesController::class,'eppendorfcelltherapy'])->name('eppendorfcelltherapy.success');


Route::get('/thermofisher-single-use-dynadrive-dynaspin',[FlatPagesController::class,'thermofishersingleusedynadrivedynaspin']);
Route::post('/thermofisher-single-use-dynadrive-dynaspin-success',[FlatPagesController::class,'thermofishersingleusedynadrivedynaspin'])->name('thermofishersingleusedynadrivedynaspin.post');
Route::get('/thermofisher-single-use-dynadrive-dynaspin-success',[FlatPagesController::class,'thermofishersingleusedynadrivedynaspin'])->name('thermofishersingleusedynadrivedynaspin.success');


Route::get('/thermofisher-single-use-dynachrom-resins',[FlatPagesController::class,'thermofishersingleusedynachromresins']);
Route::post('/thermofisher-single-use-dynachrom-resins-success',[FlatPagesController::class,'thermofishersingleusedynachromresins'])->name('thermofishersingleusedynachromresins.post');
Route::get('/thermofisher-single-use-dynachrom-resins-success',[FlatPagesController::class,'thermofishersingleusedynachromresins'])->name('thermofishersingleusedynachromresins.success');


Route::get('/thermofisher-single-use-flexible-rigid',[FlatPagesController::class,'thermofishersingleuseflexiblerigid']);
Route::post('/thermofisher-single-use-flexible-rigid-success',[FlatPagesController::class,'thermofishersingleuseflexiblerigid'])->name('thermofishersingleuseflexiblerigid.post');
Route::get('/thermofisher-single-use-flexible-rigid-success',[FlatPagesController::class,'thermofishersingleuseflexiblerigid'])->name('thermofishersingleuseflexiblerigid.success');


Route::get('/thermofisher-single-use-fill-finish',[FlatPagesController::class,'thermofishersingleusefillfinish']);
Route::post('/thermofisher-single-use-fill-finish-success',[FlatPagesController::class,'thermofishersingleusefillfinish'])->name('thermofishersingleusefillfinish.post');
Route::get('/thermofisher-single-use-fill-finish-success',[FlatPagesController::class,'thermofishersingleusefillfinish'])->name('thermofishersingleusefillfinish.success');



Route::get('/thermofisher-antibody-therapeutic-polishing-hic',[FlatPagesController::class,'thermofisherantibodytherapeuticpolishinghic']);

Route::post('/thermofisher-antibody-therapeutic-polishing-hic-success',[FlatPagesController::class,'thermofisherantibodytherapeuticpolishinghic'])->name('thermofisherantibodytherapeuticpolishinghic.post');

Route::get('/thermofisher-antibody-therapeutic-polishing-hic-success',[FlatPagesController::class,'thermofisherantibodytherapeuticpolishinghic'])->name('thermofisherantibodytherapeuticpolishinghic.success');

Route::get('/lonza-biologics-derisk-journey-clinic-manufacturability-expression',[FlatPagesController::class,'lonzabiologicsderiskjourneyclinicmanufacturabilityexpression']);

Route::get('/lonza/early-drug-development-services',[FlatPagesController::class,'earlydrugdevelopmentservices']);
Route::post('/lonza/early-drug-development-services-success',[FlatPagesController::class,'earlydrugdevelopmentservices'])->name('earlydrugdevelopmentservices.post');
Route::get('/lonza/early-drug-development-services-success',[FlatPagesController::class,'earlydrugdevelopmentservices'])->name('earlydrugdevelopmentservices.success');



Route::get('/lonza-whitepapers/de-risk-biologics-expression',[FlatPagesController::class,'lonzawhitepapersderiskbiologicsexpression']);
Route::post('/lonza-whitepapers/de-risk-biologics-expression-success',[FlatPagesController::class,'lonzawhitepapersderiskbiologicsexpression'])->name('lonzawhitepapersderiskbiologicsexpression.post');
Route::get('/lonza-whitepapers/de-risk-biologics-expression-success',[FlatPagesController::class,'lonzawhitepapersderiskbiologicsexpression'])->name('lonzawhitepapersderiskbiologicsexpression.success');

Route::get('/lonza-whitepapers/de-risk-silico-biologics-expression-success',[FlatPagesController::class,'lonzawhitepapersderiskbiologicsexpression'])->name('deriskbiologicsexpression.success');
Route::get('/lonza-whitepapers/immunogenicity-immunotoxicity-testing-challenges-success',[FlatPagesController::class,'lonzawhitepapersderiskbiologicsexpression'])->name('immunogenicityimmunotoxicitytestingchallenges.success');
Route::get('/lonza-whitepapers/maximize-value-of-early-phase-material-success',[FlatPagesController::class,'lonzawhitepapersderiskbiologicsexpression'])->name('maximizevalueofearlyphasematerial.success');


Route::get('/tf-gibco-ak-media-panel',[FlatPagesController::class,'tfgibcoakmediapanel']);
Route::post('/tf-gibco-ak-media-panel-success',[FlatPagesController::class,'tfgibcoakmediapanel'])->name('tfgibcoakmediapanel.post');
Route::get('/tf-gibco-ak-media-panel-success',[FlatPagesController::class,'tfgibcoakmediapanel'])->name('tfgibcoakmediapanel.success');

//korean routes
Route::get('/tf-gibco-ak-media-panel-kr',[FlatPagesController::class,'tfgibcoakmediapanelkr']);

//japan routes
Route::get('/tf-gibco-ak-media-panel-jp',[FlatPagesController::class,'tfgibcoakmediapaneljp']);

//china routes
Route::get('/tf-gibco-ak-media-panel-cn',[FlatPagesController::class,'tfgibcoakmediapanelcn']);


Route::get('/standard-bio-tools-cytof',[FlatPagesController::class,'standardbiotoolscytof']);
Route::post('/standard-bio-tools-cytof-success',[FlatPagesController::class,'standardbiotoolscytof'])->name('standardbiotoolscytof.post');
Route::get('/standard-bio-tools-cytof-success',[FlatPagesController::class,'standardbiotoolscytof'])->name('standardbiotoolscytof.success');
...
Route::get('bachem-microspheres-nanoparticles',[FlatPagesController::class,'bachemMicrospheresNanoparticles']);
...
Route::post('/thermofisher-scientific-bio-banking-webinar-may23-success',[WebinarController::class,'thermofisherScientificbiobankingWebinarmay23'])->name('thermofisherScientificbiobankingWebinarmay23.post');
...
Route::get('sparta-system-future-on-demand-webinar',[WebinarController::class,'spartaSystemfutureondemandWebinar']);
Route::post('/sparta-system-future-on-demand-webinar-success',[WebinarController::class,'spartaSystemfutureondemandWebinar'])->name('spartaSystemfutureondemandWebinar.post');
Route::get('/sparta-system-future-on-demand-webinar-success',[WebinarController::class,'spartaSystemfutureondemandWebinar'])->name('spartaSystemfutureondemandWebinar.success');


Route::get('sparta-system-future-on-demand-webinar-jp',[WebinarController::class,'spartaSystemfutureondemandWebinarJp']);
Route::post('/sparta-system-future-on-demand-webinar-jp-success',[WebinarController::class,'spartaSystemfutureondemandWebinarJp'])->name('spartaSystemfutureondemandWebinarJp.post');
Route::get('/sparta-system-future-on-demand-webinar-jp-success',[WebinarController::class,'spartaSystemfutureondemandWebinarJp'])->name('spartaSystemfutureondemandWebinarJp.success');


Route::get('promotion/beckman-coulter-webinar-27th-jun-23',[WebinarController::class,'beckmancoulterWebinar27thjun23']);
Route::post('promotion/beckman-coulter-webinar-27th-jun-23-success',[WebinarController::class,'beckmancoulterWebinar27thjun23'])->name('beckmancoulterWebinar27thjun23.post');
Route::get('promotion/beckman-coulter-webinar-27th-jun-23-success',[WebinarController::class,'beckmancoulterWebinar27thjun23'])->name('beckmancoulterWebinar27thjun23.success');


Route::get('promotion/beckman-coulter-webinar-20th-jul-23',[WebinarController::class,'beckmancoulterWebinar20thjul23']);
Route::post('promotion/beckman-coulter-webinar-20th-jul-23-success',[WebinarController::class,'beckmancoulterWebinar20thjul23'])->name('beckmancoulterWebinar20thjul23.post');
Route::get('promotion/beckman-coulter-webinar-20th-jul-23-success',[WebinarController::class,'beckmancoulterWebinar20thjul23'])->name('beckmancoulterWebinar20thjul23.success');


Route::get('promotion/agilent-technologies-insightful-webinar',[WebinarController::class,'agilenttechnologiesinsightfulwebinar']);
Route::post('promotion/agilent-technologies-insightful-webinar-success',[WebinarController::class,'agilenttechnologiesinsightfulwebinar'])->name('agilenttechnologiesinsightfulwebinar.post');
Route::get('promotion/agilent-technologies-insightful-webinar-success',[WebinarController::class,'agilenttechnologiesinsightfulwebinar'])->name('agilenttechnologiesinsightfulwebinar.success');


Route::get('/lonza-enprotect-webinar',[WebinarController::class,'lonzaenprotectwebinar']);
Route::post('/lonza-enprotect-webinar-success',[WebinarController::class,'lonzaenprotectwebinar'])->name('lonzaenprotectwebinar.post');
Route::get('/lonza-enprotect-webinar-success',[WebinarController::class,'lonzaenprotectwebinar'])->name('lonzaenprotectwebinar.success');


Route::get('/waters-alliance-is-hplc-system-sep13',[WebinarController::class,'watersallianceishplcsystemsep13']);
Route::post('/waters-alliance-is-hplc-system-sep13-success',[WebinarController::class,'watersallianceishplcsystemsep13'])->name('watersallianceishplcsystemsep13.post');
Route::get('/waters-alliance-is-hplc-system-sep13-success',[WebinarController::class,'watersallianceishplcsystemsep13'])->name('watersallianceishplcsystemsep13.success');

Route::get('/sparta-on-demand-webinar-may11',[WebinarController::class,'spartaondemandwebinarmay11']);
Route::post('/sparta-on-demand-webinar-may11-success',[WebinarController::class,'spartaondemandwebinarmay11'])->name('spartaondemandwebinarmay11.post');
Route::get('/sparta-on-demand-webinar-may11-success',[WebinarController::class,'spartaondemandwebinarmay11'])->name('spartaondemandwebinarmay11.success');


Route::get('promotion/idbs-webinar',[WebinarController::class,'idbswebinar']);
Route::post('promotion/idbs-webinar-success',[WebinarController::class,'idbswebinar'])->name('idbswebinar.post');
Route::get('promotion/idbs-webinar-success',[WebinarController::class,'idbswebinar'])->name('idbswebinar.success');

Route::get('/waters-virtual-bioprocess-symposium-2023-odw',[WebinarController::class,'watersvirtualbioprocesssymposium2023odw']);

Route::post('/waters-virtual-bioprocess-symposium-2023-odw-success',[WebinarController::class,'watersvirtualbioprocesssymposium2023odw'])->name('watersvirtualbioprocesssymposium2023odw.post');

Route::get('/waters-virtual-bioprocess-symposium-2023-odw-success',[WebinarController::class,'watersvirtualbioprocesssymposium2023odw'])->name('watersvirtualbioprocesssymposium2023odw.success');


Route::get('/tf-biopharma-webinar',[WebinarController::class,'tfbiopharmawebinar']);

Route::post('/tf-biopharma-webinar-success',[WebinarController::class,'tfbiopharmawebinar'])->name('tfbiopharmawebinar.post');

Route::get('/tf-biopharma-webinar-success',[WebinarController::class,'tfbiopharmawebinar'])->name('tfbiopharmawebinar.success');


Route::get('/thermofisher-the-technology-single-use-vs-stainless-steel-debate-webinar',[WebinarController::class,'thermofisherthetechnologysingleusevsstainlesssteeldebatewebinar']);
Route::post('/thermofisher-the-technology-single-use-vs-stainless-steel-debate-webinar-success',[WebinarController::class,'thermofisherthetechnologysingleusevsstainlesssteeldebatewebinar'])->name('thermofisherthetechnologysingleusevsstainlesssteeldebatewebinar.post');
Route::get('/thermofisher-the-technology-single-use-vs-stainless-steel-debate-webinar-success',[WebinarController::class,'thermofisherthetechnologysingleusevsstainlesssteeldebatewebinar'])->name('thermofisherthetechnologysingleusevsstainlesssteeldebatewebinar.success');



Route::get('/lonza-webinar/biologics-derisk-journey-clinic-manufacturability-expression',[WebinarController::class,'lonzawebinarbiologicsderiskjourneyclinicmanufacturabilityexpression']);
Route::post('/lonza-webinar/biologics-derisk-journey-clinic-manufacturability-expression-success',[WebinarController::class,'lonzawebinarbiologicsderiskjourneyclinicmanufacturabilityexpression'])->name('lonzawebinarbiologicsderiskjourneyclinicmanufacturabilityexpression.post');
Route::get('/lonza-webinar/biologics-derisk-journey-clinic-manufacturability-expression-success',[WebinarController::class,'lonzawebinarbiologicsderiskjourneyclinicmanufacturabilityexpression'])->name('lonzawebinarbiologicsderiskjourneyclinicmanufacturabilityexpression.success');


Route::get('/lonza-webinar/biologics-immunogenicity-and-immunotoxicity-de-risk',[WebinarController::class,'lonzawebinarbiologicsimmunogenicityandimmunotoxicityderisk']);
Route::post('/lonza-webinar/biologics-immunogenicity-and-immunotoxicity-de-risk-success',[WebinarController::class,'lonzawebinarbiologicsimmunogenicityandimmunotoxicityderisk'])->name('lonzawebinarbiologicsimmunogenicityandimmunotoxicityderisk.post');
Route::get('/lonza-webinar/biologics-immunogenicity-and-immunotoxicity-de-risk-success',[WebinarController::class,'lonzawebinarbiologicsimmunogenicityandimmunotoxicityderisk'])->name('lonzawebinarbiologicsimmunogenicityandimmunotoxicityderisk.success');


Route::get('/west-pharma-webinar',[WebinarController::class,'westpharmawebinar1']);
Route::post('/west-pharma-webinar-success',[WebinarController::class,'westpharmawebinar1'])->name('westpharmawebinar1.post');
Route::get('/west-pharma-webinar-success',[WebinarController::class,'westpharmawebinar1'])->name('westpharmawebinar1.success');
